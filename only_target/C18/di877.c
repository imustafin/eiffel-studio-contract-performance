...
/* {DISPENSER}.readable */
EIF_BOOLEAN F304_2538 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("readable", 303, Current, 0, 0, 3391);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DISPENSER}.writable */
EIF_BOOLEAN F304_2539 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("writable", 303, Current, 0, 0, 3392);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DISPENSER}.append */
void F304_2540 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("append", 303, Current, 0, 1, 3393);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
