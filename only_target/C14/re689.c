...
EIF_REFERENCE F423_3077 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 422, Current, 0, 0, 3993);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F684_5120(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F423_3080 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 422, Current, 0, 0, 3994);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
