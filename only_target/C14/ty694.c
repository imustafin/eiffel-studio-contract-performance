...
EIF_INTEGER_8 F669_5114 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 668, Current, 0, 0, 9106);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	ti1_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_INTEGER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2556[Dtype(RTCW(tr1))-442])(tr1, ti4_1));
