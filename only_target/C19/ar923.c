...
void F738_5192 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("make", 737, Current, 0, 1, 9930);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_0_0_1_) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ti4_2);
	if (RTAL & CK_ENSURE) {
		...
		if ((nstcall = 0, F738_5195(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_INTEGER_32 F738_5193 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F738_5194 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 737, Current, 0, 0, 9932);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F738_5192(RTCW(Result), *(EIF_REFERENCE *)(Current + _REFACS_1_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_BOOLEAN F738_5195 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_valid", 737, Current, 0, 0, 9933);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F738_5196 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F738_5197 (EIF_REFERENCE Current)
{
