...
EIF_REFERENCE F414_3077 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 413, Current, 0, 0, 3966);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F675_5120(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F414_3080 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 413, Current, 0, 0, 3967);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F414_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 320, Current, 0, 0);
