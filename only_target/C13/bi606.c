...
/* {BILINEAR}.off */
EIF_BOOLEAN F388_2710 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("off", 387, Current, 0, 0, 3812);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BILINEAR}.search */
void F388_2713 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 387, Current, 0, 1, 3813);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(3);
	(nstcall = 0, F368_2604(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		...
		if (tb2) {
			tb1 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2290[dtype-518])(Current)));
		}
		if (tb1) {
			RTCK;
		} else {
...
/* {BILINEAR}._invariant */
void F388_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 605, Current, 0, 0);
