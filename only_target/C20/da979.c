...
void F528_7489 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("make", 527, Current, 0, 1, 13754);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F36_7257(Current, arg1)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	RTHOOK(3);
	(nstcall = 0, F528_7493(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_BOOLEAN F528_7490 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("is_separator_code", 527, Current, 0, 0, 13755);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F528_7491 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F528_7492 (EIF_REFERENCE Current)
{
...
void F528_7493 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("set_value", 527, Current, 1, 1, 13758);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_REFERENCE *)(Current) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	if ((nstcall = 0, F36_7258(Current, *(EIF_REFERENCE *)(Current)))) {
		RTHOOK(5);
		...
		*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
		...
		RTHOOK(13);
		if ((nstcall = 0, F36_7259(Current, *(EIF_REFERENCE *)(Current)))) {
			RTHOOK(14);
			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
			RTHOOK(15);
			...
			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
			...
			RTHOOK(22);
			if ((nstcall = 0, F36_7260(Current, *(EIF_REFERENCE *)(Current)))) {
				RTHOOK(23);
				...
				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
				...
				RTHOOK(31);
				if ((nstcall = 0, F36_7261(Current, *(EIF_REFERENCE *)(Current)))) {
					RTHOOK(32);
					...
					*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_3_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
					...
					RTHOOK(40);
					if ((nstcall = 0, F36_7262(Current, *(EIF_REFERENCE *)(Current)))) {
						RTHOOK(41);
						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
						RTHOOK(42);
						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
						...
						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_3_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
						...
						RTHOOK(49);
						if ((nstcall = 0, F36_7263(Current, *(EIF_REFERENCE *)(Current)))) {
							RTHOOK(50);
							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
							RTHOOK(51);
							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							...
							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
							...
							RTHOOK(58);
							if ((nstcall = 0, F36_7264(Current, *(EIF_REFERENCE *)(Current)))) {
								RTHOOK(59);
								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
								RTHOOK(60);
								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
								...
								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
								...
								RTHOOK(67);
								if ((nstcall = 0, F36_7265(Current, *(EIF_REFERENCE *)(Current)))) {
									RTHOOK(68);
									*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
									RTHOOK(69);
									*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
									...
									*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
									...
									RTHOOK(76);
									if ((nstcall = 0, F36_7266(Current, *(EIF_REFERENCE *)(Current)))) {
										RTHOOK(77);
										*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
										RTHOOK(78);
										*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
										...
										*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
										...
										RTHOOK(85);
										if ((nstcall = 0, F36_7267(Current, *(EIF_REFERENCE *)(Current)))) {
											RTHOOK(86);
											*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
											RTHOOK(87);
											*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
											...
											*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
											...
											RTHOOK(94);
											if ((nstcall = 0, F36_7268(Current, *(EIF_REFERENCE *)(Current)))) {
												RTHOOK(95);
												*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
												RTHOOK(96);
												*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
												...
												*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
												...
												RTHOOK(103);
												if ((nstcall = 0, F36_7270(Current, *(EIF_REFERENCE *)(Current)))) {
													RTHOOK(104);
													*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
													RTHOOK(105);
													*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
													...
													*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
													...
													RTHOOK(112);
													if ((nstcall = 0, F36_7271(Current, *(EIF_REFERENCE *)(Current)))) {
														RTHOOK(113);
														*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
														RTHOOK(114);
														*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
														...
														*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
														...
														RTHOOK(121);
														if ((nstcall = 0, F36_7272(Current, *(EIF_REFERENCE *)(Current)))) {
															RTHOOK(122);
															*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
															RTHOOK(123);
															*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
															...
															*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
															...
															RTHOOK(130);
															if ((nstcall = 0, F36_7273(Current, *(EIF_REFERENCE *)(Current)))) {
																RTHOOK(131);
																*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
																RTHOOK(132);
																*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
																...
																*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																...
																RTHOOK(139);
																if ((nstcall = 0, F36_7274(Current, *(EIF_REFERENCE *)(Current)))) {
																	RTHOOK(140);
																	tr1 = *(EIF_REFERENCE *)(Current);
																	tr2 = *(EIF_REFERENCE *)(Current);
																	ti4_1 = *(EIF_INTEGER_32 *)(RTCW(tr2)+ _LNGOFF_1_1_0_2_);
																	tr2 = (nstcall = 1, F893_6777(RTCW(tr1), ((EIF_INTEGER_32) 3L), ti4_1));
																	ti4_1 = (nstcall = 1, F890_6575(RTCW(tr2)));
																	...
																	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_3_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
																	...
																	RTHOOK(148);
																	if ((nstcall = 0, F36_7275(Current, *(EIF_REFERENCE *)(Current)))) {
																		RTHOOK(149);
																		...
																		*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																		...
																		RTHOOK(155);
																		if ((nstcall = 0, F36_7276(Current, *(EIF_REFERENCE *)(Current)))) {
																			RTHOOK(156);
																			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																			RTHOOK(157);
																			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																			...
																			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																			...
																			RTHOOK(162);
																			if ((nstcall = 0, F36_7277(Current, *(EIF_REFERENCE *)(Current)))) {
																				RTHOOK(163);
																				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																				RTHOOK(164);
																				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																				...
																				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																				...
																				RTHOOK(169);
																				if ((nstcall = 0, F36_7278(Current, *(EIF_REFERENCE *)(Current)))) {
																					RTHOOK(170);
																					*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																					RTHOOK(171);
																					*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																					...
																					*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																					...
																					RTHOOK(176);
																					if ((nstcall = 0, F36_7279(Current, *(EIF_REFERENCE *)(Current)))) {
																						RTHOOK(177);
																						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																						RTHOOK(178);
																						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																						...
																						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																						...
																						RTHOOK(183);
																						if ((nstcall = 0, F36_7280(Current, *(EIF_REFERENCE *)(Current)))) {
																							RTHOOK(184);
																							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																							RTHOOK(185);
																							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																							...
																							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																							...
																							RTHOOK(190);
																							if ((nstcall = 0, F36_7282(Current, *(EIF_REFERENCE *)(Current)))) {
																								RTHOOK(191);
																								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
																								RTHOOK(192);
																								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
...
EIF_REFERENCE F528_7494 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F528_7495 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F528_7496 (EIF_REFERENCE Current)
{
...
/* {DATE_TIME_CODE}.name */
EIF_REFERENCE F528_7497 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F528_7498 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F528_7499 (EIF_REFERENCE Current)
{
...
/* {DATE_TIME_CODE}.type */
EIF_INTEGER_32 F528_7500 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F528_7501 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("debug_output", 527, Current, 0, 0, 13766);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(2);
	(nstcall = 1, F893_6735(RTCW(Result), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_)));
	RTHOOK(3);
	tr1 = RTMS_EX_H(" -> ",4,539835936);
	(nstcall = 1, F893_6731(RTCW(Result), tr1));
	RTHOOK(4);
	(nstcall = 1, F893_6731(RTCW(Result), *(EIF_REFERENCE *)(Current + _REFACS_1_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
