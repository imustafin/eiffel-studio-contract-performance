...
/* {CELL}.item */
EIF_NATURAL_64 F121_1933 (EIF_REFERENCE Current)
{
...
/* {CELL}.put */
void F121_1934 (EIF_REFERENCE Current, EIF_NATURAL_64 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("put", 120, Current, 0, 1, 1873);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {CELL}.replace */
void F121_1935 (EIF_REFERENCE Current, EIF_NATURAL_64 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("replace", 120, Current, 0, 1, 1874);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
