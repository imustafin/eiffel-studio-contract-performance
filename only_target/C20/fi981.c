...
{
	GTCX
	RTOUC (227,RTMS_EX_H(":/-, .",6,872260142));
}
...
EIF_INTEGER_32 F900_7547 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	...
	RTEAA("find_separator", 899, Current, 4, 2, 13812);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(5);
		ti4_1 = *(EIF_INTEGER_32 *)(RTCV(RTOUCR(227,(nstcall = 0, F900_7546), (Current)))+ _LNGOFF_1_1_0_2_);
		if ((EIF_BOOLEAN) (loc1 > ti4_1)) break;
		RTHOOK(6);
		tr1 = RTOUCR(227,(nstcall = 0, F900_7546), (Current));
		tc1 = (nstcall = 1, F893_6697(RTCW(tr1), loc1));
		ti4_2 = (nstcall = 1, F891_6617(RTCW(arg1), tc1, ((EIF_INTEGER_32) 1L)));
		...
		if ((EIF_BOOLEAN)(loc2 != ((EIF_INTEGER_32) 0L))) {
			...
			tr1 = RTOUCR(227,(nstcall = 0, F900_7546), (Current));
			tc1 = (nstcall = 1, F893_6697(RTCW(tr1), loc1));
			ti4_2 = (nstcall = 1, F891_6617(RTCW(arg1), tc1, arg2));
			loc2 = (EIF_INTEGER_32) ti4_2;
			RTHOOK(10);
	...
	if ((EIF_BOOLEAN) !loc4) {
		...
		RTHOOK(15);
		tr1 = (nstcall = 1, F893_6777(RTCW(arg1), loc1, (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 2L))));
		...
		RTHOOK(17);
		tc1 = (nstcall = 1, F893_6697(RTCW(arg1), loc1));
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (loc1 <= ti4_2)) {
				...
				if (tb2) {
					...
					if (tb3) {
						tb3 = '\0';
						tb4 = (nstcall = 1, F890_6522(RTCW(arg1), (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L))));
						if (tb4) {
							tc1 = (nstcall = 1, F893_6696(RTCW(arg1), (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L))));
...
EIF_REFERENCE F900_7548 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3)
{
	...
	RTEAA("extracted_substrings", 899, Current, 2, 3, 13813);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) (arg3 > ((EIF_INTEGER_32) 0L))) {
		RTHOOK(4);
		tr1 = (nstcall = 1, F893_6777(RTCW(arg1), arg2, (EIF_INTEGER_32) (arg3 - ((EIF_INTEGER_32) 1L))));
		loc1 = (EIF_REFERENCE) tr1;
		RTHOOK(5);
		tr1 = (nstcall = 1, F893_6777(RTCW(arg1), arg3, arg3));
		loc2 = (EIF_REFERENCE) tr1;
	} else {
		RTHOOK(6);
		tr1 = (nstcall = 1, F893_6777(RTCW(arg1), arg2, (EIF_INTEGER_32) -arg3));
		loc1 = (EIF_REFERENCE) tr1;
		RTHOOK(7);
		loc2 = RTLNS(eif_new_type(892, 0x01).id, 892, _OBJSIZ_1_1_0_3_0_0_0_0_);
		(nstcall = -1, F891_6605(RTCW(loc2), ((EIF_INTEGER_32) 0L)));
	}
	RTHOOK(8);
	{
...
EIF_BOOLEAN F900_7549 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("has_separators", 899, Current, 1, 1, 13814);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(4);
		tr1 = (nstcall = 1, F893_6777(RTCW(arg1), loc1, loc1));
		Result = (nstcall = 0, F36_7281(Current, tr1));
		RTHOOK(5);
		loc1++;
	}
	RTVI(Current, RTAL);
