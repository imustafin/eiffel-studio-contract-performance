...
EIF_REFERENCE F689_5142 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 688, Current, 1, 0, 9443);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTHOOK(3);
		Result = (nstcall = 0, F659_5114(Current));
	} else {
		RTHOOK(4);
...
EIF_BOOLEAN F689_5143 (EIF_REFERENCE Current)
{
	...
	RTEAA("after", 688, Current, 0, 0, 9444);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTHOOK(2);
		Result = (nstcall = 0, F674_5132(Current));
	} else {
		RTHOOK(3);
		Result = '\01';
...
void F689_5144 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("start", 688, Current, 0, 0, 9445);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	(nstcall = 0, F674_5139(Current));
	RTHOOK(2);
...
void F689_5145 (EIF_REFERENCE Current)
{
	...
	RTEAA("forth", 688, Current, 2, 0, 9446);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) !*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		...
		for (;;) {
			...
			RTHOOK(6);
			tr3 = *(EIF_REFERENCE *)(loc2 + O1722[Dtype(loc2)-121]);
			RTAR(Current, tr3);
...
EIF_REFERENCE F689_5147 (EIF_REFERENCE Current)
{
