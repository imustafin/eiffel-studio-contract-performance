...
EIF_INTEGER_32 F99_1531 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 98, Current, 0, 0, 1467);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {CHECK_VIOLATION}.tag */
static EIF_REFERENCE F99_1532_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F99_1532 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(39,F99_1532_body,(Current));
}
