...
/* {BOUNDED}.full */
EIF_BOOLEAN F335_2551 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("full", 334, Current, 0, 0, 3430);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BOUNDED}._invariant */
void F335_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 809, Current, 0, 0);
