...
EIF_REFERENCE F416_3077 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 415, Current, 0, 0, 3972);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F677_5120(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F416_3080 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 415, Current, 0, 0, 3973);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
