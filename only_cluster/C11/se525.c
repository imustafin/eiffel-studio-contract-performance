...
/* {SEQUENCE}.readable */
EIF_BOOLEAN F401_2749 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("readable", 400, Current, 0, 0, 3867);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.writable */
EIF_BOOLEAN F401_2750 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("writable", 400, Current, 0, 0, 3868);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.force */
void F401_2751 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("force", 400, Current, 0, 1, 3869);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F401_2752 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("append", 400, Current, 1, 1, 3870);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.put */
void F401_2753 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("put", 400, Current, 0, 1, 3871);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.prune */
void F401_2754 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune", 400, Current, 0, 1, 3872);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.prune_all */
void F401_2755 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 400, Current, 0, 1, 3873);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
