...
EIF_REFERENCE F759_5203 (EIF_REFERENCE Current)
{
	...
	RTEAA("item", 758, Current, 0, 0, 9997);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F759_5204 (EIF_REFERENCE Current)
{
	...
	RTEAA("key", 758, Current, 0, 0, 9998);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F759_5205 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("cursor_index", 758, Current, 3, 0, 9999);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F759_5206 (EIF_REFERENCE Current)
{
	...
	RTEAA("after", 758, Current, 1, 0, 10000);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F759_5207 (EIF_REFERENCE Current)
{
	...
	RTEAA("forth", 758, Current, 3, 0, 10001);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
