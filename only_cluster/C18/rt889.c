...
void F553_2322 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3, EIF_NATURAL_32 arg4)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 552, Current, 0, 4, 2350);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F553_2323 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3)
{
	GTCX
	RTEX;
	...
	RTEAA("local_value_at", 552, Current, 1, 3, 2351);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F553_2324 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3, EIF_INTEGER_16 arg4)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("set_local_value_at", 552, Current, 2, 4, 2352);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_16 F553_2325 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F553_2326 (EIF_REFERENCE Current)
{
...
EIF_NATURAL_32 F553_2327 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F553_2328 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("current_value_record", 552, Current, 0, 0, 2338);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F553_2329 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("associated_object", 552, Current, 0, 0, 2339);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F553_2330 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_TRUE;
}

/* {RT_DBG_LOCAL_RECORD}.is_same_as */
EIF_BOOLEAN F553_2331 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_same_as", 552, Current, 1, 1, 2341);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F553_2332 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("debug_output", 552, Current, 0, 0, 2342);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F553_2333 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("to_string", 552, Current, 1, 0, 2343);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	switch (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_1_2_)) {
		...
		default:
			...
			if (EIF_TRUE) {
				RTHOOK(10);
				Result = (nstcall = 0, F553_2338(Current, loc1));
			} else {
				RTHOOK(11);
				Result = RTLNS(eif_new_type(892, 0x01).id, 892, _OBJSIZ_1_1_0_3_0_0_0_0_);
				(nstcall = -1, F890_6510(RTCW(Result)));
...
void F553_2334 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_16 loc1 = (EIF_INTEGER_16) 0;
	...
	RTEAA("get_value", 552, Current, 1, 0, 2344);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr2 = (nstcall = 0, F553_2323(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_1_3_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_1_1_), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_1_0_1_0_)));
	tr1 = RTCCL(tr2);
	...
	if (tb1) {
		...
		*(EIF_INTEGER_16 *)(Current+ _I16OFF_1_0_0_) = (EIF_INTEGER_16) loc1;
		...
		RTHOOK(3);
		ti2_1 = (nstcall = 0, F553_2339(Current));
...
void F553_2335 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("restore", 552, Current, 0, 1, 2345);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	if ((nstcall = 0, F553_2331(Current, arg1))) {
	} else {
		RTHOOK(3);
		(nstcall = 0, F553_2337(Current, Current));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F553_2336 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("revert", 552, Current, 0, 1, 2346);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	(nstcall = 0, F553_2337(Current, arg1));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
void F553_2337 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("set_local_from_record", 552, Current, 1, 1, 2347);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	loc1 = arg1;
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,552,0xFF02,0xFFF8,1,0xFFFF};
		EIF_TYPE typres0;
	...
	if (EIF_TEST(loc1)) {
		...
		ti2_1 = *(EIF_INTEGER_16 *)(loc1+ _I16OFF_1_0_0_);
		(nstcall = 0, F553_2324(Current, ti4_1, ti4_2, tu4_1, ti2_1));
	} else {
...
EIF_REFERENCE F553_2338 (EIF_REFERENCE Current, EIF_INTEGER_16 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("out_value", 552, Current, 0, 1, 2348);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_16 F553_2339 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("default_value", 552, Current, 0, 0, 2349);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
