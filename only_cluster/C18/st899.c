...
void F602_4036 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make_caseless", 601, Current, 0, 1, 7202);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current+ _CHROFF_5_3_) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTHOOK(3);
	(nstcall = 0, F599_3924(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		...
		if ((EIF_BOOLEAN) !(nstcall = 0, F599_4032(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F602_4037 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make_equal_caseless", 601, Current, 0, 1, 7203);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current+ _CHROFF_5_3_) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTHOOK(3);
	(nstcall = 0, F599_3925(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("breathing_space", EX_POST);
		if ((EIF_BOOLEAN) (arg1 < *(EIF_INTEGER_32 *)(Current+ _LNGOFF_5_4_0_1_))) {
...
EIF_INTEGER_32 F602_4038 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("hash_code_of", 601, Current, 0, 1, 7204);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F602_4039 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F602_4040 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("same_keys", 601, Current, 0, 2, 7206);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F602_4041 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("is_equal", 601, Current, 0, 1, 7207);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(*(EIF_BOOLEAN *)(Current+ _CHROFF_5_3_) == tb1)) {
		RTHOOK(3);
		Result = (nstcall = 0, F599_3946(Current, arg1));
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_REFERENCE F602_4042 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("empty_duplicate", 601, Current, 0, 1, 7208);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_5_3_)) {
		...
		(nstcall = -1, F602_4036(RTCW(Result), arg1));
	} else {
		RTHOOK(4);
		Result = RTLNSMART(dftype);
		(nstcall = -1, F599_3924(RTCW(Result), arg1));
	}
	RTHOOK(5);
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_5_0_)) {
		RTHOOK(6);
