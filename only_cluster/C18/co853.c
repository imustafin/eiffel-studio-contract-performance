...
EIF_BOOLEAN F206_2471 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 205, Current, 0, 1, 3301);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F206_2474 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 205, Current, 1, 1, 3302);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F206_2476 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 205, Current, 0, 1, 3303);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
