...
void F643_5073 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("make", 642, Current, 0, 1, 9063);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F643_5074 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("item", 642, Current, 0, 0, 9064);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((EIF_BOOLEAN) !(nstcall = 0, F643_5075(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	RTHOOK(2);
	tr1 = *(EIF_REFERENCE *)(Current);
	tr2 = (nstcall = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2556[Dtype(RTCW(tr1))-442])(tr1, *(EIF_INTEGER_32 *)(Current + _REFACS_1_)));
...
EIF_BOOLEAN F643_5075 (EIF_REFERENCE Current)
{
	...
	RTEAA("after", 642, Current, 0, 0, 9065);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F643_5076 (EIF_REFERENCE Current)
{
	...
	RTEAA("forth", 642, Current, 0, 0, 9066);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F643_5077 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F643_5078 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F643_5079 (EIF_REFERENCE Current)
{
