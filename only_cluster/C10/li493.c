...
/* {LINEAR}.has */
EIF_BOOLEAN F373_2602 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("has", 372, Current, 0, 1, 3688);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(4);
	Result = (nstcall = 0, F373_2608(Current));
...
/* {LINEAR}.index_of */
EIF_INTEGER_32 F373_2603 (EIF_REFERENCE Current, EIF_POINTER arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	RTEX;
	...
	RTEAA("index_of", 372, Current, 2, 2, 3689);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) (*(EIF_BOOLEAN *)(Current + O2212[dtype-176]) && EIF_TRUE)) {
		...
		for (;;) {
			...
			if (tb1) break;
			RTHOOK(6);
			if (((nstcall = 0, F607_4078(Current)) == arg1)) {
				RTHOOK(7);
				loc1++;
			}
			RTHOOK(8);
...
/* {LINEAR}.search */
void F373_2604 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 372, Current, 0, 1, 3677);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (*(EIF_BOOLEAN *)(Current + O2212[dtype-176])) {
		...
		for (;;) {
			...
			tb2 = '\01';
			if (!(nstcall = 0, F373_2608(Current))) {
				tb2 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, F607_4078(Current)));
			}
			if (tb2) break;
			RTHOOK(5);
			(nstcall = 0, F607_4106(Current));
	...
	if (RTAL & CK_ENSURE) {
		...
		if (tb4) {
			tb3 = (arg1 == (nstcall = 0, F607_4078(Current)));
		}
		if (tb3) {
			RTCK;
		} else {
		...
		if (tb4) {
			tb3 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, F607_4078(Current)));
		}
		if (tb3) {
			RTCK;
		} else {
...
/* {LINEAR}.occurrences */
EIF_INTEGER_32 F373_2606 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
	...
	RTEAA("occurrences", 372, Current, 0, 1, 3678);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_POINTER F373_2607 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item_for_iteration", 372, Current, 0, 0, 3679);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.exhausted */
EIF_BOOLEAN F373_2608 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("exhausted", 372, Current, 0, 0, 3680);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.off */
EIF_BOOLEAN F373_2610 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("off", 372, Current, 0, 0, 3681);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.do_all */
void F373_2613 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("do_all", 372, Current, 3, 1, 3682);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	loc3 = Current;
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,261,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
	...
	for (;;) {
		RTHOOK(6);
		if ((nstcall = 0, F492_3332(Current))) break;
		RTHOOK(7);
	...
	if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(loc2 != NULL) && (EIF_BOOLEAN)(loc1 != NULL))) {
		RTHOOK(10);
		(nstcall = 1, F607_4109(RTCW(loc2), loc1));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(11);
...
/* {LINEAR}.do_if */
void F373_2614 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("do_if", 372, Current, 3, 2, 3683);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.there_exists */
EIF_BOOLEAN F373_2615 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("there_exists", 372, Current, 3, 1, 3684);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.for_all */
EIF_BOOLEAN F373_2616 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("for_all", 372, Current, 3, 1, 3685);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F373_2617 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("linear_representation", 372, Current, 0, 0, 3686);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}._invariant */
void F373_1 (EIF_REFERENCE Current, int where)
{
	GTCX
