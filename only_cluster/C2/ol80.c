...
/* {OLD_VIOLATION}.code */
EIF_INTEGER_32 F77_1489 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 76, Current, 0, 0, 1425);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {OLD_VIOLATION}.tag */
static EIF_REFERENCE F77_1490_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F77_1490 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(37,F77_1490_body,(Current));
}
