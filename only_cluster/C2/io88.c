...
EIF_INTEGER_32 F85_1501 (EIF_REFERENCE Current)
{
	...
	RTEAA("code", 84, Current, 0, 0, 1437);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F85_1502 (EIF_REFERENCE Current)
{
...
/* {IO_FAILURE}.tag */
static EIF_REFERENCE F85_1503_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F85_1503 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(20,F85_1503_body,(Current));
}
...
void F85_1504 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("set_error_code", 84, Current, 0, 1, 1440);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F85_1505 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("set_code", 84, Current, 0, 1, 1441);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F85_1506 (EIF_REFERENCE Current)
{
