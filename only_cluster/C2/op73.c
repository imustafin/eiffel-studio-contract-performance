...
EIF_INTEGER_32 F70_1475 (EIF_REFERENCE Current)
{
	...
	RTEAA("code", 69, Current, 0, 0, 1411);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F70_1476 (EIF_REFERENCE Current)
{
...
static EIF_REFERENCE F70_1477_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F70_1477 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(53,F70_1477_body,(Current));
}
...
void F70_1478 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("set_signal_code", 69, Current, 0, 1, 1414);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
