...
EIF_INTEGER_32 F88_1509 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 87, Current, 0, 0, 1445);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F88_1510_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F88_1510 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(183,F88_1510_body,(Current));
}
