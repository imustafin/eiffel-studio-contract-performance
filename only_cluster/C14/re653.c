...
EIF_REFERENCE F422_3077 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 421, Current, 0, 0, 3990);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F683_5120(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F422_3080 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 421, Current, 0, 0, 3991);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F422_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 652, Current, 0, 0);
