...
/* {BOUNDED}.full */
EIF_BOOLEAN F334_2551 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("full", 333, Current, 0, 0, 3428);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BOUNDED}._invariant */
void F334_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 772, Current, 0, 0);
