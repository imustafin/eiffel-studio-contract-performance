...
EIF_REFERENCE F31_7244 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (231,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA("days_text", 30, Current, 0, 0, 13538);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
{
	GTCX
	return RTOUCR(220,F31_7245_body,(Current));
}
...
#define Result RTOTRR
	...
	RTEAA("months_text", 30, Current, 0, 0, 13539);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
{
	GTCX
	return RTOUCR(221,F31_7246_body,(Current));
}

/* {DATE_TIME_TOOLS}.long_days_text */
static EIF_REFERENCE F31_7247_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
#define Result RTOTRR
	...
	RTEAA("long_days_text", 30, Current, 0, 0, 13540);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F31_7247 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(222,F31_7247_body,(Current));
}

/* {DATE_TIME_TOOLS}.long_months_text */
static EIF_REFERENCE F31_7248_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
#define Result RTOTRR
	...
	RTEAA("long_months_text", 30, Current, 0, 0, 13541);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F31_7248 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(223,F31_7248_body,(Current));
}
...
{
	GTCX
	RTOUC (218,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOUC (228,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOUC (229,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
