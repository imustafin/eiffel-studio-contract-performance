...
/* {LINEAR}.has */
EIF_BOOLEAN F371_2602 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("has", 370, Current, 0, 1, 3662);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(4);
	Result = (nstcall = 0, F371_2608(Current));
...
/* {LINEAR}.index_of */
EIF_INTEGER_32 F371_2603 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	RTEX;
	...
	RTEAA("index_of", 370, Current, 2, 2, 3663);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) (*(EIF_BOOLEAN *)(Current + O2212[dtype-176]) && EIF_TRUE)) {
		...
		for (;;) {
			...
			if (tb1) break;
			RTHOOK(6);
			if (((nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2290[dtype-518])(Current)) == arg1)) {
				RTHOOK(7);
				loc1++;
			}
			RTHOOK(8);
		...
		for (;;) {
			...
			if (tb2) break;
			RTHOOK(13);
			if ((EIF_BOOLEAN)((nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2290[dtype-518])(Current)) == arg1)) {
				RTHOOK(14);
				loc1++;
			}
			RTHOOK(15);
...
/* {LINEAR}.search */
void F371_2604 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 370, Current, 0, 1, 3651);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (*(EIF_BOOLEAN *)(Current + O2212[dtype-176])) {
		for (;;) {
			...
			tb1 = '\01';
			if (!(nstcall = 0, F371_2608(Current))) {
				tb1 = (arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2290[dtype-518])(Current)));
			}
			if (tb1) break;
			RTHOOK(3);
			(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2308[dtype-518])(Current));
		...
		for (;;) {
			...
			tb2 = '\01';
			if (!(nstcall = 0, F371_2608(Current))) {
				tb2 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2290[dtype-518])(Current)));
			}
			if (tb2) break;
			RTHOOK(5);
			(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2308[dtype-518])(Current));
	...
	if (RTAL & CK_ENSURE) {
		...
		if (tb4) {
			tb3 = (arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2290[dtype-518])(Current)));
		}
		if (tb3) {
			RTCK;
		} else {
		...
		if (tb4) {
			tb3 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2290[dtype-518])(Current)));
		}
		if (tb3) {
			RTCK;
		} else {
...
/* {LINEAR}.occurrences */
EIF_INTEGER_32 F371_2606 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
	...
	RTEAA("occurrences", 370, Current, 0, 1, 3652);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F371_2608(Current))) break;
		RTHOOK(4);
		Result++;
		RTHOOK(5);
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2308[dtype-518])(Current));
...
EIF_INTEGER_32 F371_2607 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
	...
	RTEAA("item_for_iteration", 370, Current, 0, 0, 3653);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	Result = (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2290[dtype-518])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
/* {LINEAR}.exhausted */
EIF_BOOLEAN F371_2608 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("exhausted", 370, Current, 0, 0, 3654);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.off */
EIF_BOOLEAN F371_2610 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("off", 370, Current, 0, 0, 3655);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.do_all */
void F371_2613 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("do_all", 370, Current, 3, 1, 3656);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		RTHOOK(7);
		ti4_1 = (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2290[dtype-518])(Current));
...
/* {LINEAR}.do_if */
void F371_2614 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("do_if", 370, Current, 3, 2, 3657);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.there_exists */
EIF_BOOLEAN F371_2615 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("there_exists", 370, Current, 3, 1, 3658);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.for_all */
EIF_BOOLEAN F371_2616 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("for_all", 370, Current, 3, 1, 3659);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F371_2617 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("linear_representation", 370, Current, 0, 0, 3660);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}._invariant */
void F371_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 425, Current, 0, 0);
