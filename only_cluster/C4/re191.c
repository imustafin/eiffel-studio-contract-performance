...
/* {REAL_32_REF}.item */
EIF_REAL_32 F816_5540 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F816_5541 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("hash_code", 815, Current, 0, 0, 11724);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R4087[dtype-815])(Current));
...
/* {REAL_32_REF}.sign */
EIF_INTEGER_32 F816_5542 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("sign", 815, Current, 0, 0, 11725);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (RTAL & CK_ENSURE) {
		...
		tr1 = (nstcall = 0, F816_5544(Current));
		tr2 = RTCCL(tr1);
...
/* {REAL_32_REF}.one */
EIF_REFERENCE F816_5543 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("one", 815, Current, 0, 0, 11726);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(2);
	(nstcall = 1, F816_5554(RTCW(Result), (EIF_REAL_32) 1.0));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
/* {REAL_32_REF}.zero */
EIF_REFERENCE F816_5544 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("zero", 815, Current, 0, 0, 11727);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F1_29(RTCW(Result)));
	RTHOOK(2);
	(nstcall = 1, F816_5554(RTCW(Result), (EIF_REAL_32) 0.0));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
/* {REAL_32_REF}.nan */
EIF_REAL_32 F816_5545 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("nan", 815, Current, 0, 0, 11728);
	RTSA(Dtype(Current));
	RTSC;
	RTIV(Current, RTAL);
...
EIF_REAL_32 F816_5546 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 Result = ((EIF_REAL_32) 0);
	...
	RTEAA("negative_infinity", 815, Current, 0, 0, 11729);
	RTSA(Dtype(Current));
	RTSC;
	RTIV(Current, RTAL);
...
EIF_REAL_32 F816_5547 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 Result = ((EIF_REAL_32) 0);
	...
	RTEAA("positive_infinity", 815, Current, 0, 0, 11730);
	RTSA(Dtype(Current));
	RTSC;
	RTIV(Current, RTAL);
...
/* {REAL_32_REF}.is_less */
EIF_BOOLEAN F816_5552 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_less", 815, Current, 0, 1, 11735);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F816_5553 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_equal", 815, Current, 0, 1, 11736);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F816_5554 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("set_item", 815, Current, 0, 1, 11737);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F816_5555 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("divisible", 815, Current, 0, 1, 11738);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F816_5556 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("exponentiable", 815, Current, 3, 1, 11739);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F816_5557 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("is_hashable", 815, Current, 0, 0, 11740);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {REAL_32_REF}.is_nan */
EIF_BOOLEAN F816_5558 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("is_nan", 815, Current, 0, 0, 11741);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F816_5559 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("is_negative_infinity", 815, Current, 0, 0, 11742);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F816_5560 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("is_positive_infinity", 815, Current, 0, 0, 11743);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F816_5561 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("make_from_reference", 815, Current, 0, 1, 11744);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	tr4_1 = *(EIF_REAL_32 *)(RTCW(arg1)+ _R32OFF_0_0_0_0_0_);
	(nstcall = 0, F816_5554(Current, tr4_1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_REFERENCE F816_5562 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("to_reference", 815, Current, 0, 0, 11745);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = RTLNS(eif_new_type(815, 0x01).id, 815, _OBJSIZ_0_0_0_0_1_0_0_0_);
	RTHOOK(2);
	(nstcall = 1, F816_5554(RTCW(Result), *(EIF_REAL_32 *)(Current+ _R32OFF_0_0_0_0_0_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_INTEGER_32 F816_5563 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("truncated_to_integer", 815, Current, 0, 0, 11746);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_64 F816_5564 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("truncated_to_integer_64", 815, Current, 0, 0, 11747);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_64 F816_5565 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("to_double", 815, Current, 0, 0, 11748);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {REAL_32_REF}.ceiling */
EIF_INTEGER_32 F816_5566 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("ceiling", 815, Current, 0, 0, 11749);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr4_1 = (nstcall = 0, (FUNCTION_CAST(EIF_REAL_32, (EIF_REFERENCE)) R4093[dtype-815])(Current));
	ti4_1 = (EIF_INTEGER_32) tr4_1;
	Result = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
/* {REAL_32_REF}.floor */
EIF_INTEGER_32 F816_5567 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("floor", 815, Current, 0, 0, 11750);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr4_1 = (nstcall = 0, (FUNCTION_CAST(EIF_REAL_32, (EIF_REFERENCE)) R4094[dtype-815])(Current));
	ti4_1 = (EIF_INTEGER_32) tr4_1;
	Result = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
/* {REAL_32_REF}.rounded */
EIF_INTEGER_32 F816_5568 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("rounded", 815, Current, 0, 0, 11751);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F816_5542(Current));
	tr4_1 = (nstcall = 0, F816_5572(Current));
	...
	*(EIF_REAL_32 *)tr1 = ((EIF_REAL_32) (tr4_1 + (EIF_REAL_32) (EIF_REAL_64) 0.5));
	ti4_1 = (nstcall = 1, F816_5567(RTCW(tr1)));
	...
	if (RTAL & CK_ENSURE) {
		...
		*(EIF_REAL_32 *)tr1 = ((EIF_REAL_32) (tr4_1 + (EIF_REAL_32) (EIF_REAL_64) 0.5));
		ti4_1 = (nstcall = 1, F816_5567(RTCW(tr1)));
		if ((EIF_BOOLEAN)(Result == (EIF_INTEGER_32) ((nstcall = 0, F816_5542(Current)) * ti4_1))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REAL_32 F816_5569 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("ceiling_real_32", 815, Current, 0, 0, 11752);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_32 F816_5570 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("floor_real_32", 815, Current, 0, 0, 11753);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_32 F816_5571 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("rounded_real_32", 815, Current, 0, 0, 11754);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = (nstcall = 0, F816_5542(Current));
	tr4_1 = (EIF_REAL_32) (ti4_1);
	tr4_2 = (nstcall = 0, F816_5572(Current));
...
/* {REAL_32_REF}.abs */
EIF_REAL_32 F816_5572 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("abs", 815, Current, 0, 0, 11755);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr4_1 = *(EIF_REAL_32 *)(RTCV((nstcall = 0, F816_5581(Current)))+ _R32OFF_0_0_0_0_0_);
...
/* {REAL_32_REF}.plus */
EIF_REFERENCE F816_5573 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("plus", 815, Current, 0, 1, 11756);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tr4_1 = *(EIF_REAL_32 *)(Current+ _R32OFF_0_0_0_0_0_);
	tr4_2 = *(EIF_REAL_32 *)(RTCW(arg1)+ _R32OFF_0_0_0_0_0_);
	(nstcall = 1, F816_5554(RTCW(Result), (EIF_REAL_32) (tr4_1 + tr4_2)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
/* {REAL_32_REF}.minus */
EIF_REFERENCE F816_5574 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("minus", 815, Current, 0, 1, 11757);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {REAL_32_REF}.product */
EIF_REFERENCE F816_5575 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("product", 815, Current, 0, 1, 11758);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F816_5576 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("quotient", 815, Current, 0, 1, 11759);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tr1 = RTCCL(arg1);
		RTTE((nstcall = 0, F816_5555(Current, tr1)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	tr4_1 = *(EIF_REAL_32 *)(Current+ _R32OFF_0_0_0_0_0_);
	tr4_2 = *(EIF_REAL_32 *)(RTCW(arg1)+ _R32OFF_0_0_0_0_0_);
	(nstcall = 1, F816_5554(RTCW(Result), (EIF_REAL_32) ((EIF_REAL_64) (tr4_1) /  (EIF_REAL_64) (tr4_2))));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
/* {REAL_32_REF}.power */
EIF_REAL_64 F816_5577 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("power", 815, Current, 0, 1, 11760);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F816_5578 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("identity", 815, Current, 0, 0, 11761);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F1_29(RTCW(Result)));
	RTHOOK(2);
	(nstcall = 1, F816_5554(RTCW(Result), (EIF_REAL_32) *(EIF_REAL_32 *)(Current+ _R32OFF_0_0_0_0_0_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
EIF_REFERENCE F816_5579 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("opposite", 815, Current, 0, 0, 11762);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {REAL_32_REF}.out */
EIF_REFERENCE F816_5580 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("out", 815, Current, 0, 0, 11763);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {REAL_32_REF}.abs_ref */
EIF_REFERENCE F816_5581 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("abs_ref", 815, Current, 0, 0, 11764);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if ((EIF_BOOLEAN) eif_is_equal_real_32 (*(EIF_REAL_32 *)(Current+ _R32OFF_0_0_0_0_0_), (EIF_REAL_32) (EIF_REAL_64) 0.0)) {
		RTHOOK(2);
		Result = (nstcall = 0, F816_5544(Current));
	} else {
		RTHOOK(3);
		if ((EIF_BOOLEAN) eif_is_greater_real_32 (*(EIF_REAL_32 *)(Current+ _R32OFF_0_0_0_0_0_), (EIF_REAL_32) (EIF_REAL_64) 0.0)) {
			RTHOOK(4);
...
void F816_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	if ((EIF_BOOLEAN) !tb2) {
		ti4_1 = (nstcall = 0, F816_5542(Current));
		tr4_1 = (EIF_REAL_32) (ti4_1);
		tb1 = (EIF_BOOLEAN) eif_is_equal_real_32 ((EIF_REAL_32) (tr4_1 * (nstcall = 0, F816_5572(Current))), *(EIF_REAL_32 *)(Current+ _R32OFF_0_0_0_0_0_));
	}
	if (tb1) {
		RTCK;
	} else {
