...
void F1_23 (EIF_REFERENCE Current)
{
	...
	if (EIF_TEST(loc3)) {
		(FUNCTION_CAST(void, (EIF_REFERENCE)) R2197[Dtype(loc3)-559])(loc3);
	} else {
		...
		tr1 = F1_5(Current);
		tr1 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2582[Dtype(RTCW(tr1))-646])(tr1);
