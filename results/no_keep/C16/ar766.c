...
EIF_BOOLEAN F573_2798 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 == Current)) {
		...
		tb1 = '\0';
		ti4_1 = F573_2795(RTCW(arg1));
		if ((EIF_BOOLEAN)(F573_2795(Current) == ti4_1)) {
			...
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					if (!(EIF_BOOLEAN) !Result) {
						tb1 = (EIF_BOOLEAN) (loc1 > F573_2797(Current));
					}
					if (tb1) break;
					tp1 = F573_2780(Current, loc1);
					tp2 = F573_2780(RTCW(arg1), loc1);
				...
				ti4_1 = F573_2795(Current);
				Result = F597_3104(RTCW(tr1), tr2, ((EIF_INTEGER_32) 0L), ((EIF_INTEGER_32) 0L), ti4_1);
			}
		}
	}
	RTLE;
...
EIF_BOOLEAN F573_2801 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	if ((EIF_BOOLEAN) (((EIF_INTEGER_32) 1L) <= arg1)) {
		Result = (EIF_BOOLEAN) (arg1 <= F573_2795(Current));
	}
	RTLE;
	return Result;
}
