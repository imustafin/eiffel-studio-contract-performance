...
void F503_2577 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2)
{
	...
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_0_) = (EIF_INTEGER_32) arg2;
	if ((EIF_BOOLEAN) (arg1 <= arg2)) {
		...
		tr4_1 = F660_3289(tr1);
		F142_1830(Current, tr4_1, (EIF_INTEGER_32) ((EIF_INTEGER_32) (arg2 - arg1) + ((EIF_INTEGER_32) 1L)));
	} else {
		F142_1829(Current, ((EIF_INTEGER_32) 0L));
	}
	RTLE;
}
		...
		if (tb1) {
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					tr4_1 = F503_2581(Current, loc1);
					tr4_2 = F503_2581(RTCW(arg1), loc1);
