...
EIF_BOOLEAN F535_2680 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F344_2122(RTCW(arg1));
		if ((EIF_BOOLEAN)(F344_2122(Current) == tb2)) {
		...
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F344_2122(Current);
		}
		if (tb1) {
			tb1 = '\0';
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (*(EIF_BOOLEAN *)(Current + O1839[dtype-280])) {
						ti4_1 = (eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1891[dtype-557])(Current));
						ti4_2 = (eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1891[Dtype(RTCW(arg1))-557])(arg1));
