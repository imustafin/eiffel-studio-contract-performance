...
EIF_BOOLEAN F538_2680 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F349_2122(RTCW(arg1));
		if ((EIF_BOOLEAN)(F349_2122(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F566_2795(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F349_2122(Current);
		}
		if (tb1) {
			tb1 = '\0';
			tr1 = F566_2785(Current);
			loc1 = tr1;
			if ((EIF_TRUE)) {
				tr1 = F566_2785(RTCW(arg1));
				loc2 = tr1;
				tb1 = (EIF_TRUE);
			}
			if (tb1) {
				...
				for (;;) {
					tb1 = '\01';
					if (!F538_2681(Current)) {
						tb1 = (EIF_BOOLEAN) !Result;
					}
					if (tb1) break;
					if (*(EIF_BOOLEAN *)(Current + O1839[dtype-280])) {
						tu4_1 = F566_2779(Current);
						tu4_2 = F566_2779(RTCW(arg1));
				...
				F566_2810(Current, loc1);
				F566_2810(RTCW(arg1), loc2);
			} else {
			}
		} else {
			tb2 = '\0';
			tb3 = '\0';
			if (F349_2122(Current)) {
				tb4 = F349_2122(RTCW(arg1));
				tb3 = tb4;
			}
			if (tb3) {
