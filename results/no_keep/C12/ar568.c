...
EIF_BOOLEAN F570_2798 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 == Current)) {
		...
		if ((EIF_BOOLEAN)(F570_2795(Current) == ti4_1)) {
			...
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					if (!(EIF_BOOLEAN) !Result) {
						tb1 = (EIF_BOOLEAN) (loc1 > F570_2797(Current));
					}
					if (tb1) break;
					Result = F570_2780(Current, loc1);
					tb2 = F570_2780(RTCW(arg1), loc1);
