...
void F575_2861 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	for (;;) {
		...
		if ((FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE, EIF_INTEGER_32)) R2294[dtype-574])(Current, loc1)) {
			...
			tr2 = RTCCL(tr1);
			tr3 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2099[Dtype(RTCW(loc5))-497])(loc5, loc1);
			tr4 = RTCCL(tr3);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE, EIF_REFERENCE)) R1888[Dtype(RTCW(loc3))-497])(loc3, tr2, tr4);
		}
		loc1++;
	}
	if (*(EIF_BOOLEAN *)(Current + O2281[dtype-574])) {
		...
		tr3 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2099[Dtype(RTCW(tr3))-497])(tr3, loc1);
		tr4 = RTCCL(tr3);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE, EIF_REFERENCE)) R1888[Dtype(RTCW(loc3))-497])(loc3, tr2, tr4);
	}
		...
		if ((EIF_BOOLEAN) ((EIF_BOOLEAN) ((EIF_BOOLEAN)(*(EIF_REFERENCE *)(Current + O2276[dtype-574]) == NULL) || (EIF_BOOLEAN)(*(EIF_REFERENCE *)(Current + O2277[dtype-574]) == NULL)) || (EIF_BOOLEAN)(*(EIF_REFERENCE *)(Current + O2279[dtype-574]) == NULL))) {
			...
			for (;;) {
				...
				if (tb1) {
					...
					tr2 = RTCCL(tr1);
					tr3 = RTCCL(loc12);
					(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE, EIF_REFERENCE)) R1888[Dtype(RTCW(loc5))-497])(loc5, tr2, tr3);
				}
				loc2++;
			}
			tb1 = '\0';
			...
			if (tb1) {
				...
				tr2 = RTCCL(tr1);
				tr3 = *(EIF_REFERENCE *)(Current + O2277[dtype-574]);
				tr3 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2099[Dtype(RTCW(tr3))-497])(tr3, (EIF_INTEGER_32) (loc3 - ((EIF_INTEGER_32) 1L)));
				tr4 = RTCCL(tr3);
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE, EIF_REFERENCE)) R1888[Dtype(RTCW(loc5))-497])(loc5, tr2, tr4);
			}
