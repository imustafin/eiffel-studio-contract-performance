...
EIF_BOOLEAN F572_2798 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 == Current)) {
		...
		tb1 = '\0';
		ti4_1 = F572_2795(RTCW(arg1));
		if ((EIF_BOOLEAN)(F572_2795(Current) == ti4_1)) {
			...
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					if (!(EIF_BOOLEAN) !Result) {
						tb1 = (EIF_BOOLEAN) (loc1 > F572_2797(Current));
					}
					if (tb1) break;
					tw1 = F572_2780(Current, loc1);
					tw2 = F572_2780(RTCW(arg1), loc1);
