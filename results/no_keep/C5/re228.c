...
EIF_BOOLEAN F211_1987 (EIF_REFERENCE Current)
{
	...
	RTGC;
	Result = '\01';
	if (!(EIF_BOOLEAN) !(FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R1780[dtype-210])(Current)) {
		tr1 = *(EIF_REFERENCE *)(Current);
		tb1 = (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE, EIF_INTEGER_32)) R2103[Dtype(RTCW(tr1))-496])(tr1, *(EIF_INTEGER_32 *)(Current + O1795[dtype-210]));
