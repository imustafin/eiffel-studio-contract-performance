...
EIF_INTEGER_32 F780_5013 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	...
	for (;;) {
		ti4_1 = *(EIF_INTEGER_32 *)(RTCV(RTOSCF(5012,F780_5012, (Current)))+ _LNGOFF_1_1_0_2_);
		if ((EIF_BOOLEAN) (loc1 > ti4_1)) break;
		tr1 = RTOSCF(5012,F780_5012, (Current));
		tc1 = F778_4866(RTCW(tr1), loc1);
		loc2 = F776_4801(RTCW(arg1), tc1, ((EIF_INTEGER_32) 1L));
		if ((EIF_BOOLEAN)(loc2 != ((EIF_INTEGER_32) 0L))) {
			loc4 = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
			tr1 = RTOSCF(5012,F780_5012, (Current));
			tc1 = F778_4866(RTCW(tr1), loc1);
			loc2 = F776_4801(RTCW(arg1), tc1, arg2);
	...
	if ((EIF_BOOLEAN) !loc4) {
		...
		tr1 = F778_4946(RTCW(arg1), loc1, (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 2L)));
		tr2 = RTMS_EX_H("[0]",3,5976157);
		tb1 = F776_4816(RTCW(tr1), tr2);
		if (tb1) {
			loc1 += ((EIF_INTEGER_32) 3L);
		}
		loc3 = F778_4866(RTCW(arg1), loc1);
		for (;;) {
			tb1 = '\01';
			ti4_2 = *(EIF_INTEGER_32 *)(RTCW(arg1)+ _LNGOFF_1_1_0_2_);
			if (!(EIF_BOOLEAN) (loc1 > ti4_2)) {
				tc1 = F778_4866(RTCW(arg1), loc1);
			...
			if ((EIF_BOOLEAN) (loc1 <= ti4_2)) {
				...
				if (tb2) {
					...
					if (tb3) {
						tb3 = '\0';
						tb4 = F770_4507(RTCW(arg1), (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L)));
						if (tb4) {
							tc1 = F778_4865(RTCW(arg1), (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L)));
...
EIF_REFERENCE F780_5014 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3)
{
	...
	if ((EIF_BOOLEAN) (arg3 > ((EIF_INTEGER_32) 0L))) {
		loc1 = F778_4946(RTCW(arg1), arg2, (EIF_INTEGER_32) (arg3 - ((EIF_INTEGER_32) 1L)));
		loc2 = F778_4946(RTCW(arg1), arg3, arg3);
	} else {
		loc1 = F778_4946(RTCW(arg1), arg2, (EIF_INTEGER_32) -arg3);
		loc2 = RTLNS(eif_new_type(777, 0x01).id, 777, _OBJSIZ_1_1_0_3_0_0_0_0_);
		F776_4789(RTCW(loc2), ((EIF_INTEGER_32) 0L));
	}
	{
