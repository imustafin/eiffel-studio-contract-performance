...
EIF_INTEGER_32 F376_2128 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("additional_space", 375, Current, 0, 0, 3235);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {RESIZABLE}.resizable */
EIF_BOOLEAN F376_2129 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("resizable", 375, Current, 0, 0, 3236);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F376_2130 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("automatic_grow", 375, Current, 0, 0, 3237);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	if (RTAL & CK_ENSURE) {
		...
		RTE_OE
		RTE_OT
		ti4_2 = (nstcall = 0, F376_2128(Current));
		tr2 = NULL;
		RTE_O
		tr2 = RTLA;
		RTE_OE
