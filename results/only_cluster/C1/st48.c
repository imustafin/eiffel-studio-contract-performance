...
void F66_933 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_BOOLEAN F66_934 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("conversion_type_valid", 65, Current, 0, 1, 987);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F61_854(Current, arg1));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_BOOLEAN F66_935 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("overflowed", 65, Current, 0, 0, 988);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F66_936 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("underflowed", 65, Current, 0, 0, 989);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F66_937 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("parse_successful", 65, Current, 0, 0, 990);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F66_938 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("separators_valid", 65, Current, 4, 1, 991);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F66_939 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_integral_double", 65, Current, 0, 0, 992);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F66_940 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("is_integral_real", 65, Current, 0, 0, 993);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F66_939(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_BOOLEAN F66_941 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_part_of_double", 65, Current, 0, 0, 994);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F66_942 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("is_part_of_real", 65, Current, 0, 0, 995);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F66_941(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_REAL_64 F66_943 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("parsed_double", 65, Current, 0, 0, 996);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_32 F66_944 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("parsed_real", 65, Current, 0, 0, 997);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr4_1 = (EIF_REAL_32) ((nstcall = 0, F66_943(Current)));
...
void F66_945 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("reset", 65, Current, 0, 1, 998);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F66_934(Current, arg1)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	*(EIF_BOOLEAN *)(Current+ _CHROFF_2_5_) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN) !(nstcall = 0, F66_935(Current))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN) !(nstcall = 0, F66_936(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F66_946 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("parse_string_with_type", 65, Current, 8, 2, 999);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTHOOK(2);
		RTCT("type_valid", EX_PRE);
		RTTE((nstcall = 0, F66_934(Current, arg2)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	RTHOOK(3);
	(nstcall = 0, F66_945(Current, arg2));
	RTHOOK(4);
...
void F66_947 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("parse_character", 65, Current, 0, 1, 1000);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	switch (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_6_0_1_)) {
		...
		case 8L:
			RTHOOK(73);
			tr1 = *(EIF_REFERENCE *)(Current + _REFACS_1_);
			tb1 = (nstcall = 1, F776_4823(RTCW(tr1), arg1));
			if ((EIF_BOOLEAN) !tb1) {
				RTHOOK(74);
				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_6_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
			}
...
EIF_REAL_64 F66_948 (EIF_REFERENCE Current)
{
...
EIF_REAL_64 F66_949 (EIF_REFERENCE Current)
{
...
EIF_REAL_64 F66_950 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F66_951 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F66_952 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F66_953 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F66_954 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F66_955 (EIF_REFERENCE Current)
{
