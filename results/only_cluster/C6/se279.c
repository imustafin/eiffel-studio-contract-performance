...
/* {SEQUENCE}.readable */
EIF_BOOLEAN F459_2200 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("readable", 458, Current, 0, 0, 3371);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.writable */
EIF_BOOLEAN F459_2201 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("writable", 458, Current, 0, 0, 3365);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.force */
void F459_2202 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("force", 458, Current, 0, 1, 3366);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(2);
	(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R1878[dtype-444])(Current, (EIF_REFERENCE) &arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		...
		if ((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE, EIF_REFERENCE)) R1836[dtype-444])(Current, (EIF_REFERENCE) &arg1))) {
			RTCK;
		} else {
			RTCF;
		}
...
/* {SEQUENCE}.append */
void F459_2203 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("append", 458, Current, 1, 1, 3367);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.put */
void F459_2204 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("put", 458, Current, 0, 1, 3368);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.prune */
void F459_2205 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune", 458, Current, 0, 1, 3369);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) !(nstcall = 0, F306_2103(Current))) {
		RTHOOK(5);
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R1896[dtype-444])(Current));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
...
/* {SEQUENCE}.prune_all */
void F459_2206 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 458, Current, 0, 1, 3370);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
