...
EIF_REFERENCE F479_2531 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 478, Current, 0, 0, 3772);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F217_1975(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F479_2534 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 478, Current, 0, 0, 3773);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F479_1 (EIF_REFERENCE Current, int where)
{
	GTCX
