...
EIF_REFERENCE F473_2531 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 472, Current, 0, 0, 3754);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F473_2534 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 472, Current, 0, 0, 3755);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
