...
EIF_BOOLEAN F534_2680 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("is_equal", 533, Current, 2, 1, 4907);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R1837[dtype-444])(Current)) == tb2)) {
		...
		if (tb1) {
			...
			if ((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R1837[dtype-444])(Current))) {
				tb4 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R1837[Dtype(RTCW(arg1))-444])(arg1));
				tb3 = tb4;
			}
			if (tb3) {
...
EIF_BOOLEAN F534_2681 (EIF_REFERENCE Current)
{
	...
	RTEAA("after", 533, Current, 0, 0, 4908);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LIST}.before */
EIF_BOOLEAN F534_2682 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("before", 533, Current, 0, 0, 4909);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
