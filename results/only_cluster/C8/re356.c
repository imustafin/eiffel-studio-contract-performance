...
EIF_REFERENCE F477_2531 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 476, Current, 0, 0, 3766);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		...
		Result = RTLNS(typres0.id, 214, _OBJSIZ_1_1_0_5_0_0_0_0_);
	}
	(nstcall = -1, F215_1975(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F477_2534 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 476, Current, 0, 0, 3767);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F477_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 355, Current, 0, 0);
