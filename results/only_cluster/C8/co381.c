...
/* {CONTAINER}.empty */
EIF_BOOLEAN F286_2083 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("empty", 285, Current, 0, 0, 2833);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F348_2122(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_BOOLEAN F286_2084 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F286_2085 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("changeable_comparison_criterion", 285, Current, 0, 0, 2835);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F286_2086 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_objects", 285, Current, 0, 0, 2836);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F286_2085(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
void F286_2087 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_references", 285, Current, 0, 0, 2837);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F286_2089 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("estimated_count_of", 285, Current, 2, 1, 2838);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	loc1 = arg1;
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,347,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
	...
	if (EIF_TEST(loc1)) {
		...
		loc2 = arg1;
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFF01,477,0,0,0xFFFF};
			EIF_TYPE typres0;
			{
				EIF_TYPE l_type;
				l_type = eif_final_id(Y1738,Y1738_gen_type,dftype,168);
