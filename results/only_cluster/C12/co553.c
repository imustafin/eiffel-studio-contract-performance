...
EIF_BOOLEAN F400_2135 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 399, Current, 0, 1, 3278);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F400_2138 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 399, Current, 1, 1, 3279);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R1878[dtype-444])(Current, (EIF_REFERENCE) &tb2));
		RTHOOK(7);
...
void F400_2140 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 399, Current, 0, 1, 3277);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
