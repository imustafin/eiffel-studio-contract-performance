...
EIF_REAL_32 F206_1969 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 205, Current, 0, 0, 2042);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tr4_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_REAL_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2099[Dtype(RTCW(tr1))-496])(tr1, ti4_1));
