...
EIF_BOOLEAN F395_2135 (EIF_REFERENCE Current, EIF_NATURAL_16 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 394, Current, 0, 1, 3263);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F395_2138 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 394, Current, 1, 1, 3264);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R1878[dtype-444])(Current, (EIF_REFERENCE) &tu2_1));
		RTHOOK(7);
...
void F395_2140 (EIF_REFERENCE Current, EIF_NATURAL_16 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 394, Current, 0, 1, 3262);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
