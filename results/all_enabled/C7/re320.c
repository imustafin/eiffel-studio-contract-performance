...
EIF_REFERENCE F475_2531 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 474, Current, 0, 0, 3760);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F213_1975(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F475_2534 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 474, Current, 0, 0, 3761);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F475_1 (EIF_REFERENCE Current, int where)
{
	GTCX
