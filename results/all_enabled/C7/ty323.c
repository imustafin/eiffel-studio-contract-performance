...
EIF_CHARACTER_32 F201_1969 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 200, Current, 0, 0, 2037);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tw1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_CHARACTER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2099[Dtype(RTCW(tr1))-496])(tr1, ti4_1));
