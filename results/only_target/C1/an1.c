...
void F1_23 (EIF_REFERENCE Current)
{
	...
	RTHOOK(1);
	loc3 = RTCCL(Current);
	loc3 = RTRV(eif_new_type(559, 0x01),loc3);
	if (EIF_TEST(loc3)) {
		RTHOOK(2);
		(nstcall = 1, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2197[Dtype(loc3)-559])(loc3));
	} else {
		RTHOOK(3);
...
void F1_27 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		RTHOOK(2);
		tr1 = RTOSCF(24,(nstcall = 0, F1_24), (Current));
		tr2 = (nstcall = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R28[Dtype(RTCW(arg1))-0])(arg1));
		(nstcall = 1, F24_413(RTCW(tr1), tr2));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
