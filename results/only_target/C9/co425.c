...
EIF_BOOLEAN F397_2135 (EIF_REFERENCE Current, EIF_NATURAL_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 396, Current, 0, 1, 3269);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F397_2138 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 396, Current, 1, 1, 3270);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if (!(EIF_BOOLEAN) !(nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R1874[dtype-444])(Current))) {
			tb2 = (nstcall = 1, F514_2649(RTCW(loc1)));
			tb1 = tb2;
		}
		if (tb1) break;
		RTHOOK(6);
		tu4_1 = (nstcall = 1, F566_2779(RTCW(loc1)));
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R1878[dtype-444])(Current, (EIF_REFERENCE) &tu4_1));
		RTHOOK(7);
...
void F397_2140 (EIF_REFERENCE Current, EIF_NATURAL_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 396, Current, 0, 1, 3268);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
