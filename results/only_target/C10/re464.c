...
EIF_REFERENCE F480_2531 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 479, Current, 0, 0, 3775);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,217,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
		...
		Result = RTLNS(typres0.id, 217, _OBJSIZ_1_1_0_5_0_0_0_0_);
	}
	(nstcall = -1, F218_1975(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F480_2534 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 479, Current, 0, 0, 3776);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F480_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 463, Current, 0, 0);
