...
EIF_BOOLEAN F208_1969 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 207, Current, 0, 0, 2044);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tb1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_BOOLEAN *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2099[Dtype(RTCW(tr1))-496])(tr1, ti4_1));
