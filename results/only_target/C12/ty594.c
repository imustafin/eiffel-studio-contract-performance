...
EIF_NATURAL_64 F209_1969 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 208, Current, 0, 0, 2045);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tu8_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_NATURAL_64 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2099[Dtype(RTCW(tr1))-496])(tr1, ti4_1));
