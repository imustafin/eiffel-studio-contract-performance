...
EIF_BOOLEAN F541_2680 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("is_equal", 540, Current, 2, 1, 4935);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F346_2122(Current)) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)((nstcall = 0, F569_2795(Current)) == ti4_3);
		}
		RTHOOK(5);
		tb1 = '\0';
		if (Result) {
		...
		if (tb1) {
			RTHOOK(6);
			tb1 = '\0';
			tr2 = (nstcall = 0, F569_2785(Current));
			loc1 = tr2;
			if ((EIF_TRUE)) {
				tr2 = (nstcall = 1, F569_2785(RTCW(arg1)));
				loc2 = tr2;
				tb1 = (EIF_TRUE);
			}
			if (tb1) {
				...
				for (;;) {
					...
					if (*(EIF_BOOLEAN *)(Current + O1839[dtype-280])) {
						...
						tc2 = (nstcall = 1, F569_2779(RTCW(arg1)));
					...
					RTHOOK(14);
					(nstcall = 1, F569_2807(RTCW(arg1)));
				}
				RTHOOK(15);
				(nstcall = 0, F569_2810(Current, loc1));
				RTHOOK(16);
				(nstcall = 1, F569_2810(RTCW(arg1), loc2));
			} else {
...
EIF_BOOLEAN F541_2681 (EIF_REFERENCE Current)
{
	...
	RTEAA("after", 540, Current, 0, 0, 4936);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_0_);
	ti4_2 = (nstcall = 0, F569_2795(Current));
...
/* {LIST}.before */
EIF_BOOLEAN F541_2682 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("before", 540, Current, 0, 0, 4937);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F541_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 535, Current, 0, 0);
	RTIT("before_definition", Current);
	if ((EIF_BOOLEAN)((nstcall = 0, F541_2682(Current)) == (EIF_BOOLEAN)(*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_0_) == ((EIF_INTEGER_32) 0L)))) {
		RTCK;
	} else {
		RTCF;
	}
	RTIT("after_definition", Current);
	if ((EIF_BOOLEAN)((nstcall = 0, F541_2681(Current)) == (EIF_BOOLEAN)(*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_0_) == (EIF_INTEGER_32) ((nstcall = 0, F569_2795(Current)) + ((EIF_INTEGER_32) 1L))))) {
		RTCK;
	} else {
		RTCF;
	}
