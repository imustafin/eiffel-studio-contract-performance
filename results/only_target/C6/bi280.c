...
/* {BILINEAR}.off */
EIF_BOOLEAN F318_2113 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("off", 317, Current, 0, 0, 3095);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BILINEAR}.search */
void F318_2116 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 317, Current, 0, 1, 3096);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(3);
	(nstcall = 0, F306_2099(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		...
		if (tb2) {
			tb1 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1845[dtype-444])(Current)));
		}
		if (tb1) {
			RTCK;
		} else {
...
/* {BILINEAR}._invariant */
void F318_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 279, Current, 0, 0);
