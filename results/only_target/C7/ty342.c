...
EIF_CHARACTER_8 F202_1969 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 201, Current, 0, 0, 2038);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tc1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2099[Dtype(RTCW(tr1))-496])(tr1, ti4_1));
