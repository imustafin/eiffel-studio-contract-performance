...
void F580_2971 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("make_caseless", 579, Current, 0, 1, 6397);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current+ _CHROFF_5_3_) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTHOOK(3);
	(nstcall = 0, F576_2859(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		...
		if ((EIF_BOOLEAN) !(nstcall = 0, F576_2967(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F580_2972 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make_equal_caseless", 579, Current, 0, 1, 6398);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current+ _CHROFF_5_3_) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTHOOK(3);
	(nstcall = 0, F576_2860(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("breathing_space", EX_POST);
		if ((EIF_BOOLEAN) (arg1 < *(EIF_INTEGER_32 *)(Current+ _LNGOFF_5_4_0_1_))) {
...
EIF_INTEGER_32 F580_2973 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("hash_code_of", 579, Current, 0, 1, 6399);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F580_2974 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F580_2975 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	...
	RTEAA("same_keys", 579, Current, 0, 2, 6401);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F580_2976 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("is_equal", 579, Current, 0, 1, 6395);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(*(EIF_BOOLEAN *)(Current+ _CHROFF_5_3_) == tb1)) {
		RTHOOK(3);
		Result = (nstcall = 0, F576_2881(Current, arg1));
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_REFERENCE F580_2977 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("empty_duplicate", 579, Current, 0, 1, 6396);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_5_3_)) {
		...
		(nstcall = -1, F580_2971(RTCW(Result), arg1));
	} else {
		RTHOOK(4);
		Result = RTLNSMART(dftype);
		(nstcall = -1, F576_2859(RTCW(Result), arg1));
	}
	RTHOOK(5);
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_5_0_)) {
		RTHOOK(6);
