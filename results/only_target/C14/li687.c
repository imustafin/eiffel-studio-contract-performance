...
void F115_1319 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_BOOLEAN arg2, EIF_BOOLEAN arg3)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 114, Current, 0, 3, 1309);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F115_1320 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F115_1321 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F115_1322 (EIF_REFERENCE Current)
{
