...
EIF_BOOLEAN F402_2135 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 401, Current, 0, 1, 3284);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F402_2138 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 401, Current, 1, 1, 3285);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R1878[dtype-444])(Current, (EIF_REFERENCE) &tp1));
		RTHOOK(7);
...
void F402_2140 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 401, Current, 0, 1, 3283);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
