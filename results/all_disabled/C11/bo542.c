...
/* {BOUNDED}.full */
EIF_BOOLEAN F362_2124 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("full", 361, Current, 0, 0, 3169);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BOUNDED}._invariant */
void F362_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 541, Current, 0, 0);
