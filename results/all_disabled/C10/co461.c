...
EIF_BOOLEAN F398_2135 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 397, Current, 0, 1, 3272);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F398_2138 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 397, Current, 1, 1, 3273);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R1878[dtype-444])(Current, (EIF_REFERENCE) &tr4_1));
		RTHOOK(7);
...
void F398_2140 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 397, Current, 0, 1, 3271);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
