...
EIF_REFERENCE F478_2531 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 477, Current, 0, 0, 3769);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F216_1975(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F478_2534 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 477, Current, 0, 0, 3770);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
