...
#ifndef INLINE_F126_1471
static EIF_NATURAL_64 inline_F126_1471 (EIF_POINTER arg1)
{
	#ifdef EIF_WINDOWS
...
EIF_INTEGER_32 F126_1470 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("pointer_length_in_bytes", 125, Current, 1, 1, 1458);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	loc1 = (nstcall = 0, F126_1471(Current, arg1));
	RTHOOK(3);
...
EIF_NATURAL_64 F126_1471 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("c_pointer_length_in_bytes", 125, Current, 0, 1, 1459);
	RTSA(Dtype(Current));
	RTSC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
...
body:;
	Result = inline_F126_1471 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
