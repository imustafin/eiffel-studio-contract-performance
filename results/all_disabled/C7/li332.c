...
/* {LINEAR}.has */
EIF_BOOLEAN F308_2097 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("has", 307, Current, 0, 1, 2980);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(4);
	Result = (nstcall = 0, F308_2103(Current));
...
/* {LINEAR}.index_of */
EIF_INTEGER_32 F308_2098 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	RTEX;
	...
	RTEAA("index_of", 307, Current, 2, 2, 2981);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) (*(EIF_BOOLEAN *)(Current + O1839[dtype-280]) && EIF_TRUE)) {
		...
		for (;;) {
			...
			if (tb1) break;
			RTHOOK(6);
			if (((nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1845[dtype-444])(Current)) == arg1)) {
				RTHOOK(7);
				loc1++;
			}
			RTHOOK(8);
		...
		for (;;) {
			...
			if (tb2) break;
			RTHOOK(13);
			if ((EIF_BOOLEAN)((nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1845[dtype-444])(Current)) == arg1)) {
				RTHOOK(14);
				loc1++;
			}
			RTHOOK(15);
...
/* {LINEAR}.search */
void F308_2099 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 307, Current, 0, 1, 2982);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (*(EIF_BOOLEAN *)(Current + O1839[dtype-280])) {
		...
		for (;;) {
			...
			tb2 = '\01';
			if (!(nstcall = 0, F308_2103(Current))) {
				tb2 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1845[dtype-444])(Current)));
			}
			if (tb2) break;
			RTHOOK(5);
			(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R1860[dtype-444])(Current));
	...
	if (RTAL & CK_ENSURE) {
		...
		if (tb4) {
			tb3 = (arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1845[dtype-444])(Current)));
		}
		if (tb3) {
			RTCK;
		} else {
		...
		if (tb4) {
			tb3 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1845[dtype-444])(Current)));
		}
		if (tb3) {
			RTCK;
		} else {
...
/* {LINEAR}.occurrences */
EIF_INTEGER_32 F308_2101 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
	...
	RTEAA("occurrences", 307, Current, 0, 1, 2983);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_CHARACTER_8 F308_2102 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item_for_iteration", 307, Current, 0, 0, 2984);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	Result = (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1845[dtype-444])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
/* {LINEAR}.exhausted */
EIF_BOOLEAN F308_2103 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("exhausted", 307, Current, 0, 0, 2985);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.off */
EIF_BOOLEAN F308_2105 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("off", 307, Current, 0, 0, 2986);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.do_all */
void F308_2108 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("do_all", 307, Current, 3, 1, 2974);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	loc3 = Current;
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,448,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
	...
	for (;;) {
		...
		RTHOOK(7);
		tc1 = (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1845[dtype-444])(Current));
	...
	if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(loc2 != NULL) && (EIF_BOOLEAN)(loc1 != NULL))) {
		RTHOOK(10);
		(nstcall = 1, F569_2810(RTCW(loc2), loc1));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(11);
...
/* {LINEAR}.do_if */
void F308_2109 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("do_if", 307, Current, 3, 2, 2975);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.there_exists */
EIF_BOOLEAN F308_2110 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("there_exists", 307, Current, 3, 1, 2976);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.for_all */
EIF_BOOLEAN F308_2111 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("for_all", 307, Current, 3, 1, 2977);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F308_2112 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("linear_representation", 307, Current, 0, 0, 2978);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}._invariant */
void F308_1 (EIF_REFERENCE Current, int where)
{
	GTCX
