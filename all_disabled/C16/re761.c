...
EIF_REFERENCE F425_3077 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 424, Current, 0, 0, 3999);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F686_5120(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F425_3080 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 424, Current, 0, 0, 4000);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F425_1 (EIF_REFERENCE Current, int where)
{
	GTCX
