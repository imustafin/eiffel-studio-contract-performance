...
EIF_REFERENCE F415_3077 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 414, Current, 0, 0, 3969);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		...
		Result = RTLNS(typres0.id, 675, _OBJSIZ_1_1_0_5_0_0_0_0_);
	}
	(nstcall = -1, F676_5120(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F415_3080 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 414, Current, 0, 0, 3970);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F415_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 332, Current, 0, 0);
