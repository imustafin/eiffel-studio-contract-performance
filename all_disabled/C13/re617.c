...
EIF_REFERENCE F421_3077 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 420, Current, 0, 0, 3987);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F682_5120(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F421_3080 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 420, Current, 0, 0, 3988);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F421_1 (EIF_REFERENCE Current, int where)
{
	GTCX
