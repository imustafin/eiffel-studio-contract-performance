...
void F552_2322 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3, EIF_NATURAL_32 arg4)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 551, Current, 0, 4, 2332);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F552_2323 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3)
{
	GTCX
	RTEX;
	...
	RTEAA("local_value_at", 551, Current, 1, 3, 2333);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F552_2324 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3, EIF_BOOLEAN arg4)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("set_local_value_at", 551, Current, 2, 4, 2334);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F552_2325 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F552_2326 (EIF_REFERENCE Current)
{
...
EIF_NATURAL_32 F552_2327 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F552_2328 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("current_value_record", 551, Current, 0, 0, 2320);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F552_2329 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("associated_object", 551, Current, 0, 0, 2321);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F552_2330 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_TRUE;
}

/* {RT_DBG_LOCAL_RECORD}.is_same_as */
EIF_BOOLEAN F552_2331 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_same_as", 551, Current, 1, 1, 2323);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F552_2332 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("debug_output", 551, Current, 0, 0, 2324);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F552_2333 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("to_string", 551, Current, 1, 0, 2325);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	switch (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_2_)) {
		...
		default:
			...
			if (EIF_TRUE) {
				RTHOOK(10);
				Result = (nstcall = 0, F552_2338(Current, loc1));
			} else {
				RTHOOK(11);
				Result = RTLNS(eif_new_type(892, 0x01).id, 892, _OBJSIZ_1_1_0_3_0_0_0_0_);
				(nstcall = -1, F890_6510(RTCW(Result)));
...
void F552_2334 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN loc1 = (EIF_BOOLEAN) 0;
	...
	RTEAA("get_value", 551, Current, 1, 0, 2326);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr2 = (nstcall = 0, F552_2323(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_3_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_1_), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_1_1_0_0_)));
	tr1 = RTCCL(tr2);
	...
	if (tb1) {
		...
		*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_) = (EIF_BOOLEAN) loc1;
		...
		RTHOOK(3);
		tb1 = (nstcall = 0, F552_2339(Current));
...
void F552_2335 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("restore", 551, Current, 0, 1, 2327);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	if ((nstcall = 0, F552_2331(Current, arg1))) {
	} else {
		RTHOOK(3);
		(nstcall = 0, F552_2337(Current, Current));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F552_2336 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("revert", 551, Current, 0, 1, 2328);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	(nstcall = 0, F552_2337(Current, arg1));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
void F552_2337 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("set_local_from_record", 551, Current, 1, 1, 2329);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	loc1 = arg1;
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,551,0xFF02,0xFFF8,1,0xFFFF};
		EIF_TYPE typres0;
	...
	if (EIF_TEST(loc1)) {
		...
		tb1 = *(EIF_BOOLEAN *)(loc1+ _CHROFF_1_0_);
		(nstcall = 0, F552_2324(Current, ti4_1, ti4_2, tu4_1, tb1));
	} else {
...
EIF_REFERENCE F552_2338 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("out_value", 551, Current, 0, 1, 2330);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F552_2339 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("default_value", 551, Current, 0, 0, 2331);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
