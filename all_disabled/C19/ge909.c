...
EIF_CHARACTER_32 F706_5154 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 705, Current, 0, 0, 9725);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((EIF_BOOLEAN) !(nstcall = 0, F706_5163(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	tw1 = (nstcall = 1, F545_3085(RTCW(tr1), *(EIF_INTEGER_32 *)(Current + O3796[dtype-691])));
...
EIF_INTEGER_32 F706_5155 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("cursor_index", 705, Current, 0, 0, 9726);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F706_5156 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("target_index", 705, Current, 0, 0, 9727);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F706_5157 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("last_index", 705, Current, 0, 0, 9728);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F706_5158 (EIF_REFERENCE Current)
{
	return (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
}

/* {GENERAL_SPECIAL_ITERATION_CURSOR}.reversed */
EIF_REFERENCE F706_5159 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("reversed", 705, Current, 0, 0, 9730);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		...
		Result = RTLNS(typres0.id, 678, _OBJSIZ_1_1_0_5_0_0_0_0_);
	}
	tr1 = (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3782[dtype-673])(Current));
	(nstcall = -1, F679_5120(RTCW(Result), tr1));
	RTHOOK(2);
	(nstcall = 1, F679_5137(RTCW(Result)));
	RTHOOK(3);
	(nstcall = 1, F679_5139(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("is_reversed", EX_POST);
		tb1 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R3777[Dtype(RTCW(Result))-673])(Result));
		if ((EIF_BOOLEAN)(tb1 == (EIF_BOOLEAN) !(nstcall = 0, F706_5164(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN)(ti4_1 == (nstcall = 0, F706_5158(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F706_5160 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("incremented", 705, Current, 0, 1, 9731);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
		RTTE((EIF_BOOLEAN) ((EIF_INTEGER_32) ((nstcall = 0, F706_5158(Current)) + arg1) > ((EIF_INTEGER_32) 0L)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	(nstcall = -1, F679_5120(RTCW(Result), tr1));
	RTHOOK(3);
	(nstcall = 1, F679_5138(RTCW(Result), (EIF_INTEGER_32) (((EIF_INTEGER_32) 1L) + arg1)));
	RTHOOK(4);
	(nstcall = 1, F679_5139(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		...
		ti4_1 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3772[Dtype(RTCW(Result))-673])(Result));
		if ((EIF_BOOLEAN)(ti4_1 == (EIF_INTEGER_32) ((nstcall = 0, F706_5158(Current)) + arg1))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		tb1 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R3777[Dtype(RTCW(Result))-673])(Result));
		if ((EIF_BOOLEAN)(tb1 == (nstcall = 0, F706_5164(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F706_5161 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("decremented", 705, Current, 0, 1, 9732);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
		RTTE((EIF_BOOLEAN) ((nstcall = 0, F706_5158(Current)) > arg1), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
EIF_REFERENCE F706_5162 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("with_step", 705, Current, 0, 1, 9733);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = -1, F679_5120(RTCW(Result), tr1));
	RTHOOK(3);
	(nstcall = 1, F679_5138(RTCW(Result), arg1));
	RTHOOK(4);
	(nstcall = 1, F679_5139(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
EIF_BOOLEAN F706_5163 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("after", 705, Current, 0, 0, 9734);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F706_5164 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_FALSE;
}

/* {GENERAL_SPECIAL_ITERATION_CURSOR}.is_valid */
EIF_BOOLEAN F706_5165 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_valid", 705, Current, 0, 0, 9736);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	ti4_2 = (nstcall = 0, F706_5157(Current));
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN)(ti4_1 == ti4_2);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
EIF_BOOLEAN F706_5166 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_first", 705, Current, 0, 0, 9737);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F706_5167 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_last", 705, Current, 0, 0, 9738);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F706_5168 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("start", 705, Current, 0, 0, 9739);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	*(EIF_INTEGER_32 *)(Current + O3796[dtype-691]) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F706_5155(Current)) == ((EIF_INTEGER_32) 1L))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F706_5156(Current)) == (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3770[dtype-673])(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((nstcall = 0, F706_5166(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F706_5169 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("forth", 705, Current, 0, 0, 9740);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
		ti4_1 = (nstcall = 0, F706_5155(Current));
		tr1 = NULL;
		RTE_O
		tr1 = RTLA;
		RTE_OE
	...
	if (RTAL & CK_ENSURE) {
		...
		RTCO(tr1);
		if ((EIF_BOOLEAN)((nstcall = 0, F706_5155(Current)) == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F706_5170 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F706_5171 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F706_5173 (EIF_REFERENCE Current)
{
