...
/* {NATURAL_32_REF}.item */
EIF_NATURAL_32 F837_5964 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F837_5965 (EIF_REFERENCE Current)
{
	...
	RTEAA("hash_code", 836, Current, 0, 0, 12266);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {NATURAL_32_REF}.sign */
EIF_INTEGER_32 F837_5966 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("sign", 836, Current, 0, 0, 12267);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (RTAL & CK_ENSURE) {
		...
		tr1 = (nstcall = 0, F837_5968(Current));
		tr2 = RTCCL(tr1);
...
/* {NATURAL_32_REF}.one */
EIF_REFERENCE F837_5967 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("one", 836, Current, 0, 0, 12268);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(2);
	(nstcall = 1, F837_5974(RTCW(Result), (EIF_NATURAL_32) ((EIF_INTEGER_32) 1L)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
/* {NATURAL_32_REF}.zero */
EIF_REFERENCE F837_5968 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("zero", 836, Current, 0, 0, 12269);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F1_29(RTCW(Result)));
	RTHOOK(2);
	(nstcall = 1, F837_5974(RTCW(Result), (EIF_NATURAL_32) ((EIF_INTEGER_32) 0L)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
EIF_CHARACTER_8 F837_5969 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("ascii_char", 836, Current, 0, 0, 12270);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F837_5979(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
EIF_BOOLEAN F837_5972 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("is_less", 836, Current, 0, 1, 12273);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F837_5973 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("is_equal", 836, Current, 0, 1, 12274);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F837_5974 (EIF_REFERENCE Current, EIF_NATURAL_32 arg1)
{
	...
	RTEAA("set_item", 836, Current, 0, 1, 12275);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F837_5975 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("divisible", 836, Current, 0, 1, 12276);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F837_5976 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("exponentiable", 836, Current, 3, 1, 12277);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F837_5977 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("is_hashable", 836, Current, 0, 0, 12278);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F837_5978 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("is_valid_character_code", 836, Current, 0, 0, 12279);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F837_5979(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_BOOLEAN F837_5979 (EIF_REFERENCE Current)
{
	...
	RTEAA("is_valid_character_8_code", 836, Current, 0, 0, 12280);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F837_5980 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("is_valid_character_32_code", 836, Current, 0, 0, 12281);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F837_5981 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("plus", 836, Current, 0, 1, 12282);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tu4_1 = *(EIF_NATURAL_32 *)(Current+ _LNGOFF_0_0_0_0_);
	tu4_2 = *(EIF_NATURAL_32 *)(RTCW(arg1)+ _LNGOFF_0_0_0_0_);
	(nstcall = 1, F837_5974(RTCW(Result), (EIF_NATURAL_32) (tu4_1 + tu4_2)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
EIF_REFERENCE F837_5982 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("minus", 836, Current, 0, 1, 12283);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F837_5983 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("product", 836, Current, 0, 1, 12284);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_64 F837_5984 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("quotient", 836, Current, 0, 1, 12285);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tr1 = RTCCL(arg1);
		RTTE((nstcall = 0, F837_5975(Current, tr1)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
EIF_REFERENCE F837_5985 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("identity", 836, Current, 0, 0, 12286);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F1_29(RTCW(Result)));
	RTHOOK(2);
	(nstcall = 1, F837_5974(RTCW(Result), (EIF_NATURAL_32) *(EIF_NATURAL_32 *)(Current+ _LNGOFF_0_0_0_0_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
EIF_REFERENCE F837_5986 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("unapplicable_opposite", 836, Current, 0, 0, 12287);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F837_5987 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("integer_quotient", 836, Current, 0, 1, 12288);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F837_5988 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("integer_remainder", 836, Current, 0, 1, 12289);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_64 F837_5989 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("power", 836, Current, 0, 1, 12290);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F837_5990 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("make_from_reference", 836, Current, 0, 1, 12291);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	tu4_1 = *(EIF_NATURAL_32 *)(RTCW(arg1)+ _LNGOFF_0_0_0_0_);
	(nstcall = 0, F837_5974(Current, tu4_1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("item_set", EX_POST);
		tu4_1 = *(EIF_NATURAL_32 *)(RTCW(arg1)+ _LNGOFF_0_0_0_0_);
...
EIF_REFERENCE F837_5991 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("to_reference", 836, Current, 0, 0, 12292);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = RTLNS(eif_new_type(836, 0x01).id, 836, _OBJSIZ_0_0_0_1_0_0_0_0_);
	RTHOOK(2);
	(nstcall = 1, F837_5974(RTCW(Result), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_0_0_0_0_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_BOOLEAN F837_5992 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("to_boolean", 836, Current, 0, 0, 12293);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_8 F837_5993 (EIF_REFERENCE Current)
{
	...
	RTEAA("as_natural_8", 836, Current, 0, 0, 12294);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_16 F837_5994 (EIF_REFERENCE Current)
{
	...
	RTEAA("as_natural_16", 836, Current, 0, 0, 12295);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_32 F837_5995 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("as_natural_32", 836, Current, 0, 0, 12296);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_64 F837_5996 (EIF_REFERENCE Current)
{
	...
	RTEAA("as_natural_64", 836, Current, 0, 0, 12297);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_8 F837_5997 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("as_integer_8", 836, Current, 0, 0, 12298);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_16 F837_5998 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("as_integer_16", 836, Current, 0, 0, 12299);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F837_5999 (EIF_REFERENCE Current)
{
	...
	RTEAA("as_integer_32", 836, Current, 0, 0, 12300);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_64 F837_6000 (EIF_REFERENCE Current)
{
	...
	RTEAA("as_integer_64", 836, Current, 0, 0, 12301);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_8 F837_6001 (EIF_REFERENCE Current)
{
	...
	RTEAA("to_natural_8", 836, Current, 0, 0, 12302);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	Result = (nstcall = 0, (FUNCTION_CAST(EIF_NATURAL_8, (EIF_REFERENCE)) R4340[dtype-836])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
EIF_NATURAL_16 F837_6002 (EIF_REFERENCE Current)
{
	...
	RTEAA("to_natural_16", 836, Current, 0, 0, 12303);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	Result = (nstcall = 0, (FUNCTION_CAST(EIF_NATURAL_16, (EIF_REFERENCE)) R4341[dtype-836])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
EIF_NATURAL_32 F837_6003 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 Result = ((EIF_NATURAL_32) 0);
	...
	RTEAA("to_natural_32", 836, Current, 0, 0, 12304);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_64 F837_6004 (EIF_REFERENCE Current)
{
	...
	RTEAA("to_natural_64", 836, Current, 0, 0, 12305);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, (FUNCTION_CAST(EIF_NATURAL_64, (EIF_REFERENCE)) R4343[dtype-836])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_INTEGER_8 F837_6005 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("to_integer_8", 836, Current, 0, 0, 12306);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	Result = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_8, (EIF_REFERENCE)) R4344[dtype-836])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
EIF_INTEGER_16 F837_6006 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("to_integer_16", 836, Current, 0, 0, 12307);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	Result = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_16, (EIF_REFERENCE)) R4345[dtype-836])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
EIF_INTEGER_32 F837_6007 (EIF_REFERENCE Current)
{
	...
	RTEAA("to_integer_32", 836, Current, 0, 0, 12308);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	Result = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R4346[dtype-836])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
EIF_INTEGER_64 F837_6008 (EIF_REFERENCE Current)
{
	...
	RTEAA("to_integer_64", 836, Current, 0, 0, 12309);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_64, (EIF_REFERENCE)) R4347[dtype-836])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_REAL_32 F837_6009 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_32 tr4_1;
	...
	RTEAA("to_real_32", 836, Current, 0, 0, 12310);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_64 F837_6010 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("to_real_64", 836, Current, 0, 0, 12311);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F837_6011 (EIF_REFERENCE Current)
{
	...
	RTEAA("to_hex_string", 836, Current, 2, 0, 12312);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	for (;;) {
		...
		*(EIF_NATURAL_32 *)tr1 = tu4_1;
		tc1 = (nstcall = 1, F837_6012(RTCW(tr1)));
...
EIF_CHARACTER_8 F837_6012 (EIF_REFERENCE Current)
{
	...
	RTEAA("to_hex_character", 836, Current, 1, 0, 12313);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_CHARACTER_8 F837_6013 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("to_character", 836, Current, 0, 0, 12314);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_CHARACTER_8 F837_6014 (EIF_REFERENCE Current)
{
	...
	RTEAA("to_character_8", 836, Current, 0, 0, 12315);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_CHARACTER_32 F837_6015 (EIF_REFERENCE Current)
{
	...
	RTEAA("to_character_32", 836, Current, 0, 0, 12316);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_character", EX_PRE);
		RTTE((nstcall = 0, F837_5980(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
EIF_REFERENCE F837_6016 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("bit_and", 836, Current, 0, 1, 12317);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = 1, F837_5974(RTCW(Result), tu4_2));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_REFERENCE F837_6017 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("bit_or", 836, Current, 0, 1, 12318);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F837_6018 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("bit_xor", 836, Current, 0, 1, 12319);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F837_6019 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("bit_not", 836, Current, 0, 0, 12320);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_32 F837_6020 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("bit_shift", 836, Current, 0, 1, 12321);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) (arg1 > ((EIF_INTEGER_32) 0L))) {
		RTHOOK(4);
		tr1 = (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R4369[dtype-836])(Current, arg1));
		tu4_1 = *(EIF_NATURAL_32 *)(RTCW(tr1)+ _LNGOFF_0_0_0_0_);
		Result = (EIF_NATURAL_32) tu4_1;
	} else {
		RTHOOK(5);
		tr1 = (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R4368[dtype-836])(Current, (EIF_INTEGER_32) -arg1));
		tu4_1 = *(EIF_NATURAL_32 *)(RTCW(tr1)+ _LNGOFF_0_0_0_0_);
		Result = (EIF_NATURAL_32) tu4_1;
	}
	RTVI(Current, RTAL);
...
EIF_REFERENCE F837_6021 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("bit_shift_left", 836, Current, 0, 1, 12322);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F837_6022 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("bit_shift_right", 836, Current, 0, 1, 12323);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F837_6023 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("bit_test", 836, Current, 0, 1, 12324);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_32 F837_6024 (EIF_REFERENCE Current, EIF_BOOLEAN arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("set_bit", 836, Current, 0, 2, 12325);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_NATURAL_32 F837_6025 (EIF_REFERENCE Current, EIF_BOOLEAN arg1, EIF_NATURAL_32 arg2)
{
	GTCX
	RTEX;
	EIF_NATURAL_32 tu4_1;
	...
	RTEAA("set_bit_with_mask", 836, Current, 0, 2, 12326);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F837_6026 (EIF_REFERENCE Current)
{
	...
	RTEAA("out", 836, Current, 0, 0, 12327);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(2);
	(nstcall = 1, F893_6741(RTCW(Result), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_0_0_0_0_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("result_not_void", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
