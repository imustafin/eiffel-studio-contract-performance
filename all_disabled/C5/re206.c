...
/* {REAL_64_REF}.item */
EIF_REAL_64 F831_5807 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F831_5808 (EIF_REFERENCE Current)
{
	...
	RTEAA("hash_code", 830, Current, 0, 0, 12085);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R4257[dtype-830])(Current));
...
EIF_INTEGER_32 F831_5809 (EIF_REFERENCE Current)
{
	...
	RTEAA("sign", 830, Current, 0, 0, 12086);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (RTAL & CK_ENSURE) {
		...
		tr1 = (nstcall = 0, F831_5811(Current));
		tr2 = RTCCL(tr1);
...
/* {REAL_64_REF}.one */
EIF_REFERENCE F831_5810 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("one", 830, Current, 0, 0, 12087);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(2);
	(nstcall = 1, F831_5821(RTCW(Result), (EIF_REAL_64) 1.0));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_REFERENCE F831_5811 (EIF_REFERENCE Current)
{
	...
	RTEAA("zero", 830, Current, 0, 0, 12088);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F1_29(RTCW(Result)));
	RTHOOK(2);
	(nstcall = 1, F831_5821(RTCW(Result), (EIF_REAL_64) 0.0));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
/* {REAL_64_REF}.nan */
EIF_REAL_64 F831_5812 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("nan", 830, Current, 0, 0, 12089);
	RTSA(Dtype(Current));
	RTSC;
	RTIV(Current, RTAL);
...
EIF_REAL_64 F831_5813 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 Result = ((EIF_REAL_64) 0);
	...
	RTEAA("negative_infinity", 830, Current, 0, 0, 12090);
	RTSA(Dtype(Current));
	RTSC;
	RTIV(Current, RTAL);
...
EIF_REAL_64 F831_5814 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 Result = ((EIF_REAL_64) 0);
	...
	RTEAA("positive_infinity", 830, Current, 0, 0, 12091);
	RTSA(Dtype(Current));
	RTSC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F831_5819 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("is_less", 830, Current, 0, 1, 12096);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F831_5820 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("is_equal", 830, Current, 0, 1, 12097);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F831_5821 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	...
	RTEAA("set_item", 830, Current, 0, 1, 12098);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F831_5822 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("divisible", 830, Current, 0, 1, 12056);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F831_5823 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("exponentiable", 830, Current, 3, 1, 12057);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F831_5824 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("is_hashable", 830, Current, 0, 0, 12058);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {REAL_64_REF}.is_nan */
EIF_BOOLEAN F831_5825 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("is_nan", 830, Current, 0, 0, 12059);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F831_5826 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("is_negative_infinity", 830, Current, 0, 0, 12060);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F831_5827 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("is_positive_infinity", 830, Current, 0, 0, 12061);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F831_5828 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("make_from_reference", 830, Current, 0, 1, 12062);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	tr8_1 = *(EIF_REAL_64 *)(RTCW(arg1)+ _R64OFF_0_0_0_0_0_0_0_0_);
	(nstcall = 0, F831_5821(Current, tr8_1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_REFERENCE F831_5829 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("to_reference", 830, Current, 0, 0, 12063);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = RTLNS(eif_new_type(830, 0x01).id, 830, _OBJSIZ_0_0_0_0_0_0_0_1_);
	RTHOOK(2);
	(nstcall = 1, F831_5821(RTCW(Result), *(EIF_REAL_64 *)(Current+ _R64OFF_0_0_0_0_0_0_0_0_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_INTEGER_32 F831_5830 (EIF_REFERENCE Current)
{
	...
	RTEAA("truncated_to_integer", 830, Current, 0, 0, 12064);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_64 F831_5831 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("truncated_to_integer_64", 830, Current, 0, 0, 12065);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_32 F831_5832 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("truncated_to_real", 830, Current, 0, 0, 12066);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {REAL_64_REF}.ceiling */
EIF_INTEGER_32 F831_5833 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("ceiling", 830, Current, 0, 0, 12067);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr8_1 = (nstcall = 0, (FUNCTION_CAST(EIF_REAL_64, (EIF_REFERENCE)) R4263[dtype-830])(Current));
	ti4_1 = (EIF_INTEGER_32) tr8_1;
	Result = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_INTEGER_32 F831_5834 (EIF_REFERENCE Current)
{
	...
	RTEAA("floor", 830, Current, 0, 0, 12068);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr8_1 = (nstcall = 0, (FUNCTION_CAST(EIF_REAL_64, (EIF_REFERENCE)) R4264[dtype-830])(Current));
	ti4_1 = (EIF_INTEGER_32) tr8_1;
	Result = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_INTEGER_32 F831_5835 (EIF_REFERENCE Current)
{
	...
	RTEAA("rounded", 830, Current, 0, 0, 12069);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F831_5809(Current));
	tr8_1 = (nstcall = 0, F831_5839(Current));
	tr1 = RTLNS(eif_new_type(832, 0x00).id, 832, _OBJSIZ_0_0_0_0_0_0_0_1_);
	*(EIF_REAL_64 *)tr1 = (EIF_REAL_64) (tr8_1 + (EIF_REAL_64) 0.5);
	...
	if (RTAL & CK_ENSURE) {
		...
		*(EIF_REAL_64 *)tr1 = (EIF_REAL_64) (tr8_1 + (EIF_REAL_64) 0.5);
		ti4_1 = (nstcall = 1, F831_5834(RTCW(tr1)));
		if ((EIF_BOOLEAN)(Result == (EIF_INTEGER_32) ((nstcall = 0, F831_5809(Current)) * ti4_1))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REAL_64 F831_5836 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("ceiling_real_64", 830, Current, 0, 0, 12070);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_64 F831_5837 (EIF_REFERENCE Current)
{
	...
	RTEAA("floor_real_64", 830, Current, 0, 0, 12071);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_64 F831_5838 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("rounded_real_64", 830, Current, 0, 0, 12072);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = (nstcall = 0, F831_5809(Current));
	tr8_1 = (EIF_REAL_64) (ti4_1);
	tr8_2 = (nstcall = 0, F831_5839(Current));
...
EIF_REAL_64 F831_5839 (EIF_REFERENCE Current)
{
	...
	RTEAA("abs", 830, Current, 0, 0, 12073);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr8_1 = *(EIF_REAL_64 *)(RTCV((nstcall = 0, F831_5848(Current)))+ _R64OFF_0_0_0_0_0_0_0_0_);
...
EIF_REFERENCE F831_5840 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("plus", 830, Current, 0, 1, 12074);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tr8_1 = *(EIF_REAL_64 *)(Current+ _R64OFF_0_0_0_0_0_0_0_0_);
	tr8_2 = *(EIF_REAL_64 *)(RTCW(arg1)+ _R64OFF_0_0_0_0_0_0_0_0_);
	(nstcall = 1, F831_5821(RTCW(Result), (EIF_REAL_64) (tr8_1 + tr8_2)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
EIF_REFERENCE F831_5841 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("minus", 830, Current, 0, 1, 12075);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F831_5842 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("product", 830, Current, 0, 1, 12076);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F831_5843 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("quotient", 830, Current, 0, 1, 12077);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tr1 = RTCCL(arg1);
		RTTE((nstcall = 0, F831_5822(Current, tr1)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	tr8_1 = *(EIF_REAL_64 *)(Current+ _R64OFF_0_0_0_0_0_0_0_0_);
	tr8_2 = *(EIF_REAL_64 *)(RTCW(arg1)+ _R64OFF_0_0_0_0_0_0_0_0_);
	(nstcall = 1, F831_5821(RTCW(Result), (EIF_REAL_64) ((EIF_REAL_64) (tr8_1) /  (EIF_REAL_64) (tr8_2))));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
/* {REAL_64_REF}.power */
EIF_REAL_64 F831_5844 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	GTCX
	RTEX;
	EIF_REAL_64 Result = ((EIF_REAL_64) 0);
	...
	RTEAA("power", 830, Current, 0, 1, 12078);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F831_5845 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("identity", 830, Current, 0, 0, 12079);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F1_29(RTCW(Result)));
	RTHOOK(2);
	(nstcall = 1, F831_5821(RTCW(Result), (EIF_REAL_64) *(EIF_REAL_64 *)(Current+ _R64OFF_0_0_0_0_0_0_0_0_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("result_exists", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
EIF_REFERENCE F831_5846 (EIF_REFERENCE Current)
{
	...
	RTEAA("opposite", 830, Current, 0, 0, 12080);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F831_5847 (EIF_REFERENCE Current)
{
	...
	RTEAA("out", 830, Current, 0, 0, 12081);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F831_5848 (EIF_REFERENCE Current)
{
	...
	RTEAA("abs_ref", 830, Current, 0, 0, 12082);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if ((EIF_BOOLEAN) eif_is_equal_real_64 (*(EIF_REAL_64 *)(Current+ _R64OFF_0_0_0_0_0_0_0_0_), (EIF_REAL_64) 0.0)) {
		RTHOOK(2);
		Result = (nstcall = 0, F831_5811(Current));
	} else {
		RTHOOK(3);
		if ((EIF_BOOLEAN) eif_is_greater_real_64 (*(EIF_REAL_64 *)(Current+ _R64OFF_0_0_0_0_0_0_0_0_), (EIF_REAL_64) 0.0)) {
			RTHOOK(4);
...
void F831_1 (EIF_REFERENCE Current, int where)
{
	...
	if ((EIF_BOOLEAN) !tb2) {
		ti4_1 = (nstcall = 0, F831_5809(Current));
		tr8_1 = (EIF_REAL_64) (ti4_1);
		tb1 = (EIF_BOOLEAN) eif_is_equal_real_64 ((EIF_REAL_64) (tr8_1 * (nstcall = 0, F831_5839(Current))), *(EIF_REAL_64 *)(Current+ _R64OFF_0_0_0_0_0_0_0_0_));
	}
	if (tb1) {
		RTCK;
	} else {
