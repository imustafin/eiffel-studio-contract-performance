...
void F136_2398 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_BOOLEAN arg2, EIF_BOOLEAN arg3)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 135, Current, 0, 3, 2989);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F136_2399 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F136_2400 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F136_2401 (EIF_REFERENCE Current)
{
