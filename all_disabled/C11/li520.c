...
void F137_2398 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_BOOLEAN arg2, EIF_BOOLEAN arg3)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 136, Current, 0, 3, 2994);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F137_2399 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F137_2400 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F137_2401 (EIF_REFERENCE Current)
{
...
void F137_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 519, Current, 0, 0);
