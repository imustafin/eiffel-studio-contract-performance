...
EIF_BOOLEAN F489_3331 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	RTEAA("is_equal", 488, Current, 2, 1, 6155);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2210[dtype-442])(Current)) == tb2)) {
		...
		if (tb1) {
			...
			if ((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2210[dtype-442])(Current))) {
				tb4 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2210[Dtype(RTCW(arg1))-442])(arg1));
				tb3 = tb4;
			}
			if (tb3) {
...
EIF_BOOLEAN F489_3332 (EIF_REFERENCE Current)
{
	...
	RTEAA("after", 488, Current, 0, 0, 6156);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LIST}.before */
EIF_BOOLEAN F489_3333 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("before", 488, Current, 0, 0, 6157);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LIST}._invariant */
void F489_1 (EIF_REFERENCE Current, int where)
{
	GTCX
