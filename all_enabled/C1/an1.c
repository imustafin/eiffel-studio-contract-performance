...
void F1_23 (EIF_REFERENCE Current)
{
	...
	if (EIF_TEST(loc3)) {
		RTHOOK(2);
		(nstcall = 1, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2934[Dtype(loc3)-592])(loc3));
	} else {
		RTHOOK(3);
...
void F1_27 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		(nstcall = 1, F22_145(RTCW(tr1), tr2));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
{
	GTCX
	return RTOUCR(1,F1_28_body,(Current));
}
