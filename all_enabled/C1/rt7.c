...
void F19_47 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
...
EIF_INTEGER_32 F19_48 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F19_49 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F19_50 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F19_51 (EIF_REFERENCE Current)
{
...
void F19_52 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("set_maximum_record_count", 18, Current, 0, 1, 64);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F19_53 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("set_flatten_when_closing", 18, Current, 0, 1, 65);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F19_54 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("set_keep_calls_records", 18, Current, 0, 1, 66);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F19_55 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("set_recording_values", 18, Current, 0, 1, 67);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
