...
EIF_REFERENCE F103_1553 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("string_type", 102, Current, 0, 0, 1486);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F103_1554 (EIF_REFERENCE Current)
{
	return (EIF_INTEGER_32) ((EIF_INTEGER_32) 2000L);
}

/* {STRING_32_SEARCHER}.substring_index_with_deltas */
EIF_INTEGER_32 F103_1555 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2, EIF_INTEGER_32 arg3, EIF_INTEGER_32 arg4)
{
	GTCX
	RTEX;
	...
	RTEAA("substring_index_with_deltas", 102, Current, 9, 4, 1488);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if ((EIF_BOOLEAN)(arg1 == arg2)) {
		...
		for (;;) {
			...
			for (;;) {
				...
				RTHOOK(20);
				tw1 = (nstcall = 1, F545_3085(RTCW(loc8), (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc2) - ((EIF_INTEGER_32) 1L))));
			...
			if (loc5) {
				...
				if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + loc4) <= arg4)) {
					RTHOOK(28);
					tw1 = (nstcall = 1, F545_3085(RTCW(loc8), (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc4) - ((EIF_INTEGER_32) 1L))));
					...
					if ((EIF_BOOLEAN) (loc6 > ((EIF_INTEGER_32) 2000L))) {
						...
						RTHOOK(31);
						ti4_1 = (nstcall = 1, F536_3085(RTCW(loc7), loc6));
						loc1 += ti4_1;
					}
				} else {
					RTHOOK(32);
...
EIF_INTEGER_32 F103_1556 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2, EIF_INTEGER_32 arg3, EIF_INTEGER_32 arg4, EIF_INTEGER_32 arg5)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("fuzzy_index", 102, Current, 11, 5, 1489);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
			...
			if ((EIF_BOOLEAN)(loc9 != NULL)) {
				...
				for (;;) {
					...
					for (;;) {
						...
						RTHOOK(26);
						tw1 = (nstcall = 1, F545_3085(RTCW(loc10), (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc2) - ((EIF_INTEGER_32) 1L))));
						tu4_1 = (EIF_NATURAL_32) tw1;
						tu4_2 = (nstcall = 1, (FUNCTION_CAST(EIF_NATURAL_32, (EIF_REFERENCE, EIF_INTEGER_32)) R4644[Dtype(RTCW(arg2))-892])(arg2, (EIF_INTEGER_32) (loc2 + ((EIF_INTEGER_32) 1L))));
						if ((EIF_BOOLEAN)(tu4_1 != tu4_2)) {
							RTHOOK(27);
					...
					if (loc7) {
						...
						if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + loc5) <= arg4)) {
							...
							for (;;) {
								...
								RTHOOK(39);
								tw1 = (nstcall = 1, F545_3085(RTCW(loc10), (EIF_INTEGER_32) ((EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc5) - loc2) - ((EIF_INTEGER_32) 1L))));
								ti4_1 = (EIF_INTEGER_32) (tw1);
