...
EIF_BOOLEAN F691_5142 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 690, Current, 1, 0, 9455);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((EIF_BOOLEAN) !(nstcall = 0, F691_5143(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTHOOK(3);
		Result = (nstcall = 0, F673_5114(Current));
	} else {
		RTHOOK(4);
...
EIF_BOOLEAN F691_5143 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("after", 690, Current, 0, 0, 9456);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTHOOK(2);
		Result = (nstcall = 0, F688_5132(Current));
	} else {
		RTHOOK(3);
		Result = '\01';
...
void F691_5144 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("start", 690, Current, 0, 0, 9457);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	(nstcall = 0, F688_5139(Current));
	RTHOOK(2);
...
void F691_5145 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("forth", 690, Current, 2, 0, 9458);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F691_5146 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F691_5147 (EIF_REFERENCE Current)
{
