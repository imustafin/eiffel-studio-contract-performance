...
void F138_2398 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_BOOLEAN arg2, EIF_BOOLEAN arg3)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 137, Current, 0, 3, 2999);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F138_2399 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F138_2400 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F138_2401 (EIF_REFERENCE Current)
{
...
void F138_1 (EIF_REFERENCE Current, int where)
{
	GTCX
