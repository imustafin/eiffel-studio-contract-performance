...
/* {SEQUENCE}.readable */
EIF_BOOLEAN F410_2749 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("readable", 409, Current, 0, 0, 3930);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.writable */
EIF_BOOLEAN F410_2750 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("writable", 409, Current, 0, 0, 3931);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.force */
void F410_2751 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("force", 409, Current, 0, 1, 3932);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F410_2752 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("append", 409, Current, 1, 1, 3933);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.put */
void F410_2753 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("put", 409, Current, 0, 1, 3934);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.prune */
void F410_2754 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune", 409, Current, 0, 1, 3935);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.prune_all */
void F410_2755 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 409, Current, 0, 1, 3936);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
