...
EIF_REFERENCE F424_3077 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 423, Current, 0, 0, 3996);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F685_5120(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F424_3080 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 423, Current, 0, 0, 3997);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F424_1 (EIF_REFERENCE Current, int where)
{
	GTCX
