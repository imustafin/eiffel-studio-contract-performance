...
/* {BOUNDED}.full */
EIF_BOOLEAN F336_2551 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("full", 335, Current, 0, 0, 3432);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BOUNDED}._invariant */
void F336_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 844, Current, 0, 0);
