...
#ifndef INLINE_F522_3737
static EIF_NATURAL_64 inline_F522_3737 (EIF_POINTER arg1)
{
	#ifdef EIF_WINDOWS
...
EIF_INTEGER_32 F522_3736 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("pointer_length_in_bytes", 521, Current, 1, 1, 6443);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	loc1 = (nstcall = 0, F522_3737(Current, arg1));
	RTHOOK(3);
...
EIF_NATURAL_64 F522_3737 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("c_pointer_length_in_bytes", 521, Current, 0, 1, 6444);
	RTSA(Dtype(Current));
	RTSC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
...
body:;
	Result = inline_F522_3737 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
