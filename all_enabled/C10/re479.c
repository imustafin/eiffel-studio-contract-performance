...
EIF_REFERENCE F419_3077 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 418, Current, 0, 0, 3981);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		...
		Result = RTLNS(typres0.id, 679, _OBJSIZ_1_1_0_5_0_0_0_0_);
	}
	(nstcall = -1, F680_5120(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F419_3080 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 418, Current, 0, 0, 3982);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F419_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 478, Current, 0, 0);
