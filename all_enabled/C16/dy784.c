...
void F515_3470 (EIF_REFERENCE Current, EIF_NATURAL_64 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("put_left", 514, Current, 1, 1, 6261);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((nstcall = 0, F300_2537(Current))) {
		RTHOOK(4);
		(nstcall = 0, F615_4111(Current, arg1));
	} else {
		RTHOOK(5);
		if ((nstcall = 0, F500_3332(Current))) {
			...
			RTHOOK(7);
			(nstcall = 0, F615_4116(Current, arg1));
			RTHOOK(8);
			(nstcall = 0, F615_4103(Current, ((EIF_INTEGER_32) 2L)));
		} else {
			RTHOOK(9);
			...
			RTHOOK(11);
			(nstcall = 0, F615_4116(Current, loc1));
			RTHOOK(12);
...
void F515_3472 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("merge_left", 514, Current, 0, 1, 6258);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tu8_1 = (nstcall = 1, F615_4078(RTCW(arg1)));
		(nstcall = 0, F615_4115(Current, tu8_1));
		RTHOOK(8);
		(nstcall = 1, F615_4127(RTCW(arg1)));
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		RTCT("new_count", EX_POST);
...
void F515_3473 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("merge_right", 514, Current, 0, 1, 6259);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		RTHOOK(7);
		tu8_1 = (nstcall = 1, F615_4078(RTCW(arg1)));
		(nstcall = 0, F615_4116(Current, tu8_1));
		RTHOOK(8);
		(nstcall = 1, F615_4107(RTCW(arg1)));
		RTHOOK(9);
		(nstcall = 1, F615_4130(RTCW(arg1)));
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
		RTCT("new_count", EX_POST);
...
void F515_3477 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 514, Current, 0, 0, 6260);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	(nstcall = 0, F485_3327(Current));
	RTHOOK(2);
	(nstcall = 0, F615_4107(Current));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
