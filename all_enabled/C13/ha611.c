...
EIF_REFERENCE F760_5203 (EIF_REFERENCE Current)
{
	...
	RTEAA("item", 759, Current, 0, 0, 10003);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tr2 = *(EIF_REFERENCE *)(RTCW(tr1) + O3010[Dtype(tr1)-595]);
...
EIF_INTEGER_32 F760_5204 (EIF_REFERENCE Current)
{
	...
	RTEAA("key", 759, Current, 0, 0, 10004);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	tr1 = *(EIF_REFERENCE *)(Current);
	tr2 = *(EIF_REFERENCE *)(RTCW(tr1) + O3011[Dtype(tr1)-595]);
...
EIF_INTEGER_32 F760_5205 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("cursor_index", 759, Current, 3, 0, 10005);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F760_5206 (EIF_REFERENCE Current)
{
	...
	RTEAA("after", 759, Current, 1, 0, 10006);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F760_5207 (EIF_REFERENCE Current)
{
	...
	RTEAA("forth", 759, Current, 3, 0, 10007);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
		...
		for (;;) {
			...
			if (!(EIF_BOOLEAN) (loc1 > loc2)) {
				tr3 = *(EIF_REFERENCE *)(Current);
				tr4 = *(EIF_REFERENCE *)(RTCW(tr3) + O3011[Dtype(tr3)-595]);
