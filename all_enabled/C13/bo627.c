...
/* {BOUNDED}.full */
EIF_BOOLEAN F330_2551 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("full", 329, Current, 0, 0, 3420);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BOUNDED}._invariant */
void F330_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 626, Current, 0, 0);
