...
EIF_INTEGER_32 F40_7302 (EIF_REFERENCE Current)
{
	...
	RTEAA("hour", 39, Current, 0, 0, 13587);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F40_7303 (EIF_REFERENCE Current)
{
	...
	RTEAA("minute", 39, Current, 0, 0, 13588);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F40_7304 (EIF_REFERENCE Current)
{
	...
	RTEAA("second", 39, Current, 0, 0, 13589);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_64 F40_7305 (EIF_REFERENCE Current)
{
	return *(EIF_REAL_64 *)(Current + O5083[Dtype(Current)-39]);
}


/* {TIME_VALUE}.compact_time */
EIF_INTEGER_32 F40_7306 (EIF_REFERENCE Current)
{
	return *(EIF_INTEGER_32 *)(Current + O5084[Dtype(Current)-39]);
}
...
EIF_REAL_64 F40_7307 (EIF_REFERENCE Current)
{
	...
	RTEAA("fine_second", 39, Current, 0, 0, 13592);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R5076[dtype-39])(Current));
	tr8_1 = (EIF_REAL_64) (ti4_1);
	Result = *(EIF_REAL_64 *)(Current + O5083[dtype-39]);
...
EIF_INTEGER_32 F40_7308 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("milli_second", 39, Current, 0, 0, 13593);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F40_7309 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("micro_second", 39, Current, 0, 0, 13594);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F40_7310 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("nano_second", 39, Current, 0, 0, 13595);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F40_7311 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("set_hour", 39, Current, 0, 1, 13596);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + O5084[dtype-39]) = (EIF_INTEGER_32) ti4_2;
	RTHOOK(4);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + O5084[dtype-39]);
	...
	*(EIF_INTEGER_32 *)(Current + O5084[dtype-39]) = (EIF_INTEGER_32) ti4_2;
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R5074[dtype-39])(Current)) == arg1)) {
			RTCK;
		} else {
			RTCF;
		}
...
void F40_7312 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("set_minute", 39, Current, 0, 1, 13597);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + O5084[dtype-39]) = (EIF_INTEGER_32) ti4_2;
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R5075[dtype-39])(Current)) == arg1)) {
			RTCK;
		} else {
			RTCF;
		}
...
void F40_7313 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("set_second", 39, Current, 0, 1, 13598);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + O5084[dtype-39]) = (EIF_INTEGER_32) ti4_2;
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R5076[dtype-39])(Current)) == arg1)) {
			RTCK;
		} else {
			RTCF;
		}
...
void F40_7314 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("set_fine_second", 39, Current, 1, 1, 13599);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(4);
	(nstcall = 0, F40_7313(Current, loc1));
	RTHOOK(5);
	tr8_1 = (EIF_REAL_64) (loc1);
	*(EIF_REAL_64 *)(Current + O5083[dtype-39]) = (EIF_REAL_64) (EIF_REAL_64) (arg1 - tr8_1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(6);
		RTCT("fine_second_set", EX_POST);
		if ((EIF_BOOLEAN) eif_is_equal_real_64 ((nstcall = 0, (FUNCTION_CAST(EIF_REAL_64, (EIF_REFERENCE)) R5077[dtype-39])(Current)), arg1)) {
			RTCK;
		} else {
			RTCF;
		}
...
void F40_7315 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("set_fractionals", 39, Current, 0, 1, 13600);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(3);
	*(EIF_REAL_64 *)(Current + O5083[dtype-39]) = (EIF_REAL_64) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("second_same", EX_POST);
		RTCO(tr1);
		if ((EIF_BOOLEAN)((nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R5076[dtype-39])(Current)) == ti4_1)) {
			RTCK;
		} else {
			RTCF;
		}
