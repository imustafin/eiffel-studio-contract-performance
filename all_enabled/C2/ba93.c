...
EIF_INTEGER_32 F90_1517 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 89, Current, 0, 0, 1453);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F90_1518_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F90_1518 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(29,F90_1518_body,(Current));
}
