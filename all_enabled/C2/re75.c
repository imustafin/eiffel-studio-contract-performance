...
EIF_INTEGER_32 F72_1479 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 71, Current, 0, 0, 1415);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F72_1480_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F72_1480 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(167,F72_1480_body,(Current));
}
