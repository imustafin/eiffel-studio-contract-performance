...
EIF_INTEGER_32 F92_1519 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 91, Current, 0, 0, 1455);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F92_1520_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F92_1520 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(182,F92_1520_body,(Current));
}
