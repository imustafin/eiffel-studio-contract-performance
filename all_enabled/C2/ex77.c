...
EIF_INTEGER_32 F74_1483 (EIF_REFERENCE Current)
{
	...
	RTEAA("code", 73, Current, 0, 0, 1419);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F74_1484_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F74_1484 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(41,F74_1484_body,(Current));
}
