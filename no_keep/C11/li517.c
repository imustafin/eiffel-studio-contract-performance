...
EIF_REFERENCE F520_3521 (EIF_REFERENCE Current)
{
	...
	RTGC;
	{
		...
		tr1 = RTLNS(typres0.id, 136, _OBJSIZ_1_2_0_0_0_0_0_0_);
	}
	F137_2398(RTCW(tr1), *(EIF_REFERENCE *)(Current + _REFACS_1_), *(EIF_BOOLEAN *)(Current+ _CHROFF_2_2_), *(EIF_BOOLEAN *)(Current+ _CHROFF_2_1_));
	RTLE;
...
void F520_3542 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	if (F292_2537(Current)) {
		...
		*(EIF_REFERENCE *)(Current + _REFACS_1_) = (EIF_REFERENCE) loc1;
		...
		loc2 = F520_3558(Current);
		if ((EIF_BOOLEAN)(loc2 != NULL)) {
			F123_1937(RTCW(loc2), loc1);
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_2_)) {
				RTAR(Current, loc1);
				*(EIF_REFERENCE *)(Current + _REFACS_1_) = (EIF_REFERENCE) loc1;
			}
...
void F520_3552 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 != Current)) {
		...
		tb1 = F292_2537(RTCW(arg1));
		if ((EIF_BOOLEAN) !tb1) {
			F520_3560(Current);
			loc1 = F520_3521(RTCW(arg1));
			F520_3534(RTCW(arg1));
			for (;;) {
				tb1 = F520_3528(RTCW(arg1));
				if (tb1) break;
				ti4_1 = F520_3517(RTCW(arg1));
				F520_3542(Current, ti4_1);
				F520_3535(Current);
				F520_3536(RTCW(arg1));
			}
			if ((EIF_BOOLEAN)(loc1 != NULL)) {
				F520_3540(RTCW(arg1), loc1);
			}
		}
	}
	RTLE;
...
EIF_REFERENCE F520_3554 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTGC;
	{
		...
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		tr1 = RTLNS(typres0.id, 122, _OBJSIZ_1_0_0_1_0_0_0_0_);
	}
	F118_1934(RTCW(tr1), arg1);
	RTLE;
	return (EIF_REFERENCE) tr1;
}
