...
EIF_REFERENCE F898_7021 (EIF_REFERENCE Current)
{
	...
	/* END INLINED CODE */
	;
	F894_6892(Current, loc1, ((EIF_INTEGER_32) 0L), (EIF_INTEGER_32) (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_2_) - ((EIF_INTEGER_32) 1L)));
	tr1 = RTLNSMART(dftype);
	F898_7012(RTCW(tr1), loc1, ((EIF_INTEGER_32) 0L), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_2_));
	RTLE;
...
EIF_REFERENCE F898_7023 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2)
{
	...
	if ((EIF_BOOLEAN) ((EIF_BOOLEAN) ((EIF_BOOLEAN) (((EIF_INTEGER_32) 1L) <= arg1) && (EIF_BOOLEAN) (arg1 <= arg2)) && (EIF_BOOLEAN) (arg2 <= *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_2_)))) {
		...
		F545_3102(RTCW(loc1), tw1);
		tr1 = RTLNSMART(dftype);
		F898_7012(RTCW(tr1), loc1, ((EIF_INTEGER_32) 0L), loc2);
		RTLE;
		return (EIF_REFERENCE) tr1;
	} else {
		RTLE;
		return (EIF_REFERENCE) RTOUCR(31,F898_7028, (Current));
	}/* NOTREACHED */
...
#define Result RTOTRR
	...
	F894_6847(RTCW(tr1), ((EIF_INTEGER_32) 0L));
...
{
	GTCX
	return RTOUCR(31,F898_7028_body,(Current));
}
