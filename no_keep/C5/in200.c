...
EIF_REFERENCE F825_5710 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	F1_29(RTCW(Result));
	ti8_1 = *(EIF_INTEGER_64 *)(RTCW(arg1)+ _I64OFF_0_0_0_0_0_0_0_);
	F825_5702(RTCW(Result), (EIF_INTEGER_64) (*(EIF_INTEGER_64 *)(Current+ _I64OFF_0_0_0_0_0_0_0_) + ti8_1));
	RTLE;
	return Result;
}
...
EIF_REFERENCE F825_5715 (EIF_REFERENCE Current)
{
	...
	Result = RTLNSMART(Dftype(Current));
	F1_29(RTCW(Result));
	F825_5702(RTCW(Result), (EIF_INTEGER_64) -*(EIF_INTEGER_64 *)(Current+ _I64OFF_0_0_0_0_0_0_0_));
	RTLE;
	return Result;
}
...
EIF_NATURAL_64 F825_5733 (EIF_REFERENCE Current)
{
	...
	return (EIF_NATURAL_64) (FUNCTION_CAST(EIF_NATURAL_64, (EIF_REFERENCE)) R4198[Dtype(Current)-824])(Current);
}
...
EIF_INTEGER_32 F825_5737 (EIF_REFERENCE Current)
{
	...
	return (EIF_INTEGER_32) (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R4201[Dtype(Current)-824])(Current);
}
...
EIF_REFERENCE F825_5756 (EIF_REFERENCE Current)
{
	...
	F893_6738(RTCW(Result), *(EIF_INTEGER_64 *)(Current+ _I64OFF_0_0_0_0_0_0_0_));
	RTLE;
	return Result;
}
