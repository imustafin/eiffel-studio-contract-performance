...
void F534_3083 (EIF_REFERENCE Current, EIF_POINTER arg1, EIF_INTEGER_32 arg2)
{
	...
	;
	F534_3104(Current, arg1, ((EIF_INTEGER_32) 0L), (EIF_INTEGER_32) (arg2 - ((EIF_INTEGER_32) 1L)));
	RTLE;
}
...
EIF_REFERENCE F534_3091 (EIF_REFERENCE Current)
{
	...
	RTGC;
	{
		...
		tr1 = RTLNS(typres0.id, 446, _OBJSIZ_1_1_0_2_0_0_0_0_);
	}
	F447_3189(RTCW(tr1), Current);
	RTLE;
...
void F534_3109 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3)
{
	...
	if ((EIF_BOOLEAN) (arg1 < arg2)) {
		...
		if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (arg2 + arg3) >= (EIF_INTEGER_32) eif_builtin_SPECIAL_count (Current))) {
			...
			F534_3104(Current, tp1, ti4_1, (EIF_INTEGER_32) ((EIF_INTEGER_32) (arg2 + arg3) - ((EIF_INTEGER_32) 1L)));
		}
		for (;;) {
		...
		for (;;) {
			...
			/* END INLINED CODE */
			tp1 = tp2;
			F534_3101(Current, tp1, (EIF_INTEGER_32) (loc1 - loc3));
			loc1++;
		}
	}
	RTLE;
...
EIF_REFERENCE F534_3118 (EIF_REFERENCE Current, EIF_POINTER arg1, EIF_INTEGER_32 arg2)
{
	...
	RTGC;
	Result = F534_3117(Current, arg2);
	ti4_1 = (EIF_INTEGER_32) eif_builtin_SPECIAL_count (Result);
	F534_3104(RTCW(Result), arg1, ti4_1, (EIF_INTEGER_32) (arg2 - ((EIF_INTEGER_32) 1L)));
	RTLE;
	return Result;
}
