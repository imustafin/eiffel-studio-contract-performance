...
void F455_3187 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2)
{
	...
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_0_) = (EIF_INTEGER_32) arg2;
	if ((EIF_BOOLEAN) (arg1 <= arg2)) {
		...
		tu8_1 = F782_5304(tr1);
		F150_2406(Current, tu8_1, (EIF_INTEGER_32) ((EIF_INTEGER_32) (arg2 - arg1) + ((EIF_INTEGER_32) 1L)));
	} else {
		F150_2405(Current, ((EIF_INTEGER_32) 0L));
	}
	RTLE;
}
		...
		if (tb1) {
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					tu8_1 = F455_3191(Current, loc1);
					tu8_2 = F455_3191(RTCW(arg1), loc1);
				...
				ti4_1 = F455_3198(Current);
				Result = F542_3098(RTCW(tr1), tr2, ((EIF_INTEGER_32) 0L), ((EIF_INTEGER_32) 0L), ti4_1);
			}
		}
	}
	RTLE;
