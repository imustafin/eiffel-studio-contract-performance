...
EIF_BOOLEAN F494_3331 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F295_2537(RTCW(arg1));
		if ((EIF_BOOLEAN)(F295_2537(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F608_4094(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F295_2537(Current);
		}
		if (tb1) {
			tb1 = '\0';
			tr1 = F608_4084(Current);
			loc1 = tr1;
			if ((EIF_TRUE)) {
				tr1 = F608_4084(RTCW(arg1));
				loc2 = tr1;
				tb1 = (EIF_TRUE);
			}
			if (tb1) {
				...
				for (;;) {
					tb1 = '\01';
					if (!F494_3332(Current)) {
						tb1 = (EIF_BOOLEAN) !Result;
					}
					if (tb1) break;
					if (*(EIF_BOOLEAN *)(Current + O2212[dtype-176])) {
						tu4_1 = F608_4078(Current);
						tu4_2 = F608_4078(RTCW(arg1));
				...
				F608_4109(Current, loc1);
				F608_4109(RTCW(arg1), loc2);
			} else {
			}
		} else {
			tb2 = '\0';
			tb3 = '\0';
			if (F295_2537(Current)) {
				tb4 = F295_2537(RTCW(arg1));
				tb3 = tb4;
			}
			if (tb3) {
