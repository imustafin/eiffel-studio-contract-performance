...
EIF_BOOLEAN F610_4097 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 == Current)) {
		...
		tb1 = '\0';
		ti4_1 = F610_4094(RTCW(arg1));
		if ((EIF_BOOLEAN)(F610_4094(Current) == ti4_1)) {
			...
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					if (!(EIF_BOOLEAN) !Result) {
						tb1 = (EIF_BOOLEAN) (loc1 > F610_4096(Current));
					}
					if (tb1) break;
					tc1 = F610_4079(Current, loc1);
					tc2 = F610_4079(RTCW(arg1), loc1);
				...
				ti4_1 = F610_4094(Current);
				Result = F537_3098(RTCW(tr1), tr2, ((EIF_INTEGER_32) 0L), ((EIF_INTEGER_32) 0L), ti4_1);
			}
		}
	}
	RTLE;
...
EIF_BOOLEAN F610_4100 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	if ((EIF_BOOLEAN) (((EIF_INTEGER_32) 1L) <= arg1)) {
		Result = (EIF_BOOLEAN) (arg1 <= F610_4094(Current));
	}
	RTLE;
	return Result;
}
