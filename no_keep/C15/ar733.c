...
EIF_BOOLEAN F614_4097 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 == Current)) {
		...
		tb1 = '\0';
		ti4_1 = F614_4094(RTCW(arg1));
		if ((EIF_BOOLEAN)(F614_4094(Current) == ti4_1)) {
			...
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					if (!(EIF_BOOLEAN) !Result) {
						tb1 = (EIF_BOOLEAN) (loc1 > F614_4096(Current));
					}
					if (tb1) break;
					ti2_1 = F614_4079(Current, loc1);
					ti2_2 = F614_4079(RTCW(arg1), loc1);
				...
				ti4_1 = F614_4094(Current);
				Result = F541_3098(RTCW(tr1), tr2, ((EIF_INTEGER_32) 0L), ((EIF_INTEGER_32) 0L), ti4_1);
			}
		}
	}
	RTLE;
