...
EIF_BOOLEAN F502_3331 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F302_2537(RTCW(arg1));
		if ((EIF_BOOLEAN)(F302_2537(Current) == tb2)) {
		...
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F302_2537(Current);
		}
		if (tb1) {
			tb1 = '\0';
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (*(EIF_BOOLEAN *)(Current + O2212[dtype-176])) {
						Result = (eif_optimize_return = 1, *(EIF_BOOLEAN *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2258[dtype-518])(Current));
						tb2 = (eif_optimize_return = 1, *(EIF_BOOLEAN *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2258[Dtype(RTCW(arg1))-518])(arg1));
