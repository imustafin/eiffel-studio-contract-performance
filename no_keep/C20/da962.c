...
static EIF_REFERENCE F31_7245_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTOTP;
	{
		static EIF_TYPE_INDEX typarr0[] = {530,0xFF01,892,0xFFFF};
		EIF_TYPE typres0;
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	RTAR(tr2,tr3);
	tr1 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) F531_3091)(tr2);
	Result = (EIF_REFERENCE) tr1;
	F177_2465(RTCW(Result));
	RTOTE;
	RTLE;
	RTEE;
	return Result;
...
EIF_REFERENCE F31_7245 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(43,F31_7245_body,(Current));
}

/* {DATE_TIME_TOOLS}.months_text */
static EIF_REFERENCE F31_7246_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
EIF_REFERENCE F31_7246 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(44,F31_7246_body,(Current));
}

/* {DATE_TIME_TOOLS}.date_default_format_string */

EIF_REFERENCE F31_7249 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (41,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}

/* {DATE_TIME_TOOLS}.time_default_format_string */

EIF_REFERENCE F31_7250 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (48,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}

/* {DATE_TIME_TOOLS}.default_format_string */

EIF_REFERENCE F31_7251 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (49,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
