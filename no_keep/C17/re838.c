...
EIF_BOOLEAN F688_5132 (EIF_REFERENCE Current)
{
	...
	RTGC;
	Result = '\01';
	if (!(EIF_BOOLEAN) !F688_5134(Current)) {
		tr1 = *(EIF_REFERENCE *)(Current);
		tb1 = (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE, EIF_INTEGER_32)) R2560[Dtype(RTCW(tr1))-442])(tr1, *(EIF_INTEGER_32 *)(Current + O3793[Dtype(Current)-673]));
