		...
		if (loc3) {
			...
			if ((EIF_BOOLEAN)(loc2 == ti4_1)) {
				...
				for (;;) {
					...
					tr1 = F812_5317(Current, loc1);
					tr2 = F812_5317(RTCW(arg1), loc1);
	...
	for (;;) {
		...
		switch ((EIF_NATURAL_8) eif_builtin_TUPLE_item_code (Current, loc1)) {
			...
			case 0U:
				...
				if (EIF_TEST(loc4)) {
					loc3 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3816[Dtype(loc4)-764])(loc4);
				} else {
		...
		tr1 = RTOUCR(1,F812_5443, (Current));
		ti4_1 = F642_5068(RTCW(tr1), loc1);
...
EIF_BOOLEAN F812_5345 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	...
	if ((EIF_BOOLEAN)(arg1 == NULL)) {
		if ((EIF_BOOLEAN)((EIF_NATURAL_8) eif_builtin_TUPLE_item_code (Current, arg2) == ((EIF_NATURAL_8) 0U))) {
			tr1 = F1_5(Current);
			tr1 = F766_5289(tr1, arg2);
			Result = (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R3882[Dtype(RTCW(tr1))-765])(tr1);
		...
		switch ((EIF_NATURAL_8) eif_builtin_TUPLE_item_code (Current, arg2)) {
			...
			case 0U:
				...
				tr1 = F1_5(Current);
				tr1 = F766_5289(tr1, arg2);
				ti4_1 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3877[Dtype(RTCW(tr1))-765])(tr1);
				Result = F126_1974(RTCW(loc1), loc2, ti4_1);
				break;
			default:
				RTEC(EN_WHEN);
		}
...
void F812_5421 (EIF_REFERENCE Current)
{
	...
	tr2 = RTOUCR(3,F812_5441, (Current));
	...
	if (EIF_TEST(loc4)) {
		loc1 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		loc2 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R2079[Dtype(loc4)-530])(loc4);
		for (;;) {
			if ((EIF_BOOLEAN) (loc1 > loc2)) break;
			loc3 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2556[Dtype(loc4)-443])(loc4, (EIF_INTEGER_32) (loc1 - ((EIF_INTEGER_32) 1L)));
			tr1 = RTCCL(loc3);
			if (F812_5345(Current, tr1, loc1)) {
				tr1 = RTCCL(loc3);
				F812_5350(Current, tr1, loc1);
			} else {
				F593_3856(Current);
			}
			loc1++;
...
{
	GTCX
	return RTOUCR(1,F812_5443_body,(Current));
}
