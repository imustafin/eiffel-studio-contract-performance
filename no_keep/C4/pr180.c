...
EIF_INTEGER_32 F642_5064 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	if ((EIF_BOOLEAN) (arg1 <= ((EIF_INTEGER_32) 2L))) {
		...
		for (;;) {
			if (F642_5067(Current, Result)) break;
...
EIF_REFERENCE F642_5066 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	F457_3186(RTCW(Result), (EIF_BOOLEAN) 0, ((EIF_INTEGER_32) 1L), arg1);
	loc1 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	for (;;) {
		if ((EIF_BOOLEAN) (loc1 > arg1)) break;
		F457_3210(RTCW(Result), (EIF_BOOLEAN) 1, loc1);
		loc1 += ((EIF_INTEGER_32) 2L);
	}
	if ((EIF_BOOLEAN) (arg1 >= ((EIF_INTEGER_32) 2L))) {
		F457_3210(RTCW(Result), (EIF_BOOLEAN) 1, ((EIF_INTEGER_32) 2L));
	}
	loc1 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	for (;;) {
		if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 * loc1) > arg1)) break;
		tb1 = F457_3191(RTCW(Result), loc1);
		if (tb1) {
			loc2 = (EIF_INTEGER_32) (EIF_INTEGER_32) (loc1 * loc1);
			for (;;) {
				if ((EIF_BOOLEAN) (loc2 > arg1)) break;
				F457_3210(RTCW(Result), (EIF_BOOLEAN) 0, loc2);
...
EIF_INTEGER_32 F642_5068 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTGC;
	loc3 = RTOUCR(35,F642_5071, (Current));
	tb1 = '\0';
	...
	if (tb1) {
		ti4_1 = F449_3191(RTCW(loc3), arg1);
		RTLE;
		return (EIF_INTEGER_32) ti4_1;
	} else {
		ti4_1 = F642_5072(Current, arg1);
		loc1 = F642_5066(Current, ti4_1);
		Result = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		loc2 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		for (;;) {
			if ((EIF_BOOLEAN)(loc2 == arg1)) break;
			Result++;
			tb1 = F457_3191(RTCW(loc1), Result);
			if (tb1) {
				loc2++;
			}
		}
...
#define Result RTOTRR
	...
	RTGC;
	RTOTP;
	ti4_1 = F642_5072(Current, ((EIF_INTEGER_32) 200L));
	loc1 = F642_5066(Current, ti4_1);
	{
	...
	F449_3186(RTCW(tr1), ((EIF_INTEGER_32) 0L), ((EIF_INTEGER_32) 1L), ((EIF_INTEGER_32) 200L));
	Result = (EIF_REFERENCE) tr1;
	loc3 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	loc2 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	for (;;) {
		if ((EIF_BOOLEAN) (loc3 > ((EIF_INTEGER_32) 200L))) break;
		tb1 = F457_3191(RTCW(loc1), loc2);
		if (tb1) {
			F449_3210(RTCW(Result), loc2, loc3);
			loc3++;
		}
		loc2++;
	}
...
{
	GTCX
	return RTOUCR(35,F642_5071_body,(Current));
}
