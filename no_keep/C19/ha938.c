...
void F600_3926 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	for (;;) {
		...
		if (F600_4003(Current, loc1)) {
			...
			/* END INLINED CODE */
			ti4_2 = ti4_3;
			F600_3970(RTCW(loc3), ti4_1, ti4_2);
		}
		loc1++;
	}
	...
	if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == loc1) || EIF_FALSE)) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (loc4 >= ((EIF_INTEGER_32) 0L))) {
				...
				/* END INLINED CODE */
				loc12 = ti4_2;
				if (F600_3947(Current, loc12, arg1)) {
...
EIF_INTEGER_32 F600_3944 (EIF_REFERENCE Current)
{
	...
	return (EIF_INTEGER_32) F600_3968(Current, ((EIF_INTEGER_32) -1L));
}
...
EIF_INTEGER_32 F600_3945 (EIF_REFERENCE Current)
{
	...
	tr1 = *(EIF_REFERENCE *)(Current + _REFACS_1_);
	ti4_1 = (EIF_INTEGER_32) eif_builtin_SPECIAL_count (tr1);
	Result = F600_3969(Current, ti4_1);
	RTLE;
	return Result;
}
...
EIF_BOOLEAN F600_3946 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if (tb1) {
		Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		loc1 = F600_3938(Current);
		for (;;) {
			tb1 = F763_5206(loc1);
			if (tb1) break;
			if ((EIF_BOOLEAN) !Result) break;
			ti4_1 = F763_5204(loc1);
			F600_3966(RTCW(arg1), ti4_1);
			tb2 = F600_3956(RTCW(arg1));
			if (tb2) {
				if (*(EIF_BOOLEAN *)(Current+ _CHROFF_4_0_)) {
					ti4_1 = F763_5203(loc1);
...
EIF_BOOLEAN F600_3958 (EIF_REFERENCE Current)
{
	...
	return (EIF_BOOLEAN) F600_4005(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_3_));
}
...
EIF_BOOLEAN F600_3962 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	return (EIF_BOOLEAN) F600_4004(Current, arg1);
}
...
void F600_3963 (EIF_REFERENCE Current)
{
	...
	RTGC;
	ti4_1 = F600_3968(Current, ((EIF_INTEGER_32) -1L));
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_3_) = (EIF_INTEGER_32) ti4_1;
	RTLE;
}
...
void F600_3964 (EIF_REFERENCE Current)
{
	...
	RTGC;
	ti4_1 = F600_3968(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_3_));
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_3_) = (EIF_INTEGER_32) ti4_1;
	RTLE;
}
...
void F600_3966 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	F600_4014(Current, arg1);
	if (F600_3956(Current)) {
		tr1 = *(EIF_REFERENCE *)(Current);
		ti4_1 = F600_3992(Current);
		/* INLINED CODE (SPECIAL.item) */
		ti4_3 = *((EIF_INTEGER_32 *)RTCW(tr1) + (ti4_1));
		/* END INLINED CODE */
		ti4_1 = ti4_3;
	...
	if (F600_3956(Current)) {
		...
		*(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_0_) = (EIF_INTEGER_32) ti4_1;
		...
		if ((EIF_BOOLEAN)(*(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_5_) == ((EIF_INTEGER_32) -1L))) {
			...
			loc2 = F600_4002(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_5_));
...
void F600_3971 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2)
{
	...
	if (F600_3957(Current)) {
		...
		if ((EIF_BOOLEAN)(*(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_5_) == ((EIF_INTEGER_32) -1L))) {
			...
			loc3 = F600_4002(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_5_));
...
void F600_3978 (EIF_REFERENCE Current)
{
	...
	tr1 = *(EIF_REFERENCE *)(Current + _REFACS_2_);
	F536_3104(RTCW(tr1), ((EIF_INTEGER_32) -1L), ((EIF_INTEGER_32) 0L), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_1_));
		...
		if ((EIF_BOOLEAN) ((EIF_BOOLEAN) ((EIF_BOOLEAN)(*(EIF_REFERENCE *)(Current) == NULL) || (EIF_BOOLEAN)(*(EIF_REFERENCE *)(Current + _REFACS_1_) == NULL)) || (EIF_BOOLEAN)(*(EIF_REFERENCE *)(Current + _REFACS_3_) == NULL))) {
			...
			for (;;) {
				...
				if (tb1) {
					...
					/* END INLINED CODE */
					ti4_2 = ti4_3;
					F600_3970(RTCW(loc5), ti4_2, loc12);
				}
				loc2++;
			}
			tb1 = '\0';
			...
			if (tb1) {
				...
				/* END INLINED CODE */
				ti4_3 = ti4_5;
				F600_3970(RTCW(loc5), ti4_2, ti4_3);
			}
...
void F600_4033 (EIF_REFERENCE Current)
{
	...
	F600_3926(Current, (EIF_INTEGER_32) (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_9_) + (EIF_INTEGER_32) (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_4_3_0_9_) / ((EIF_INTEGER_32) 2L))));
}
