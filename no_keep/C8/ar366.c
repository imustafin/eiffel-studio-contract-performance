...
void F446_3187 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2)
{
	...
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_0_) = (EIF_INTEGER_32) arg2;
	if ((EIF_BOOLEAN) (arg1 <= arg2)) {
		...
		tu1_1 = F776_5304(tr1);
		F141_2406(Current, tu1_1, (EIF_INTEGER_32) ((EIF_INTEGER_32) (arg2 - arg1) + ((EIF_INTEGER_32) 1L)));
	} else {
		F141_2405(Current, ((EIF_INTEGER_32) 0L));
	}
	RTLE;
}
		...
		if (tb1) {
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					tu1_1 = F446_3191(Current, loc1);
					tu1_2 = F446_3191(RTCW(arg1), loc1);
				...
				ti4_1 = F446_3198(Current);
				Result = F533_3098(RTCW(tr1), tr2, ((EIF_INTEGER_32) 0L), ((EIF_INTEGER_32) 0L), ti4_1);
			}
		}
	}
	RTLE;
