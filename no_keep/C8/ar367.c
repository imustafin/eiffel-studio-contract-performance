...
EIF_BOOLEAN F606_4097 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	...
	if ((EIF_BOOLEAN)(arg1 == Current)) {
		...
		if ((EIF_BOOLEAN)(F606_4094(Current) == ti4_1)) {
			...
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					if (!(EIF_BOOLEAN) !Result) {
						tb1 = (EIF_BOOLEAN) (loc1 > F606_4096(Current));
					}
					if (tb1) break;
					tu1_1 = F606_4079(Current, loc1);
					tu1_2 = F606_4079(RTCW(arg1), loc1);
...
EIF_BOOLEAN F606_4100 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	if ((EIF_BOOLEAN) (((EIF_INTEGER_32) 1L) <= arg1)) {
		Result = (EIF_BOOLEAN) (arg1 <= F606_4094(Current));
	}
	RTLE;
	return Result;
}
