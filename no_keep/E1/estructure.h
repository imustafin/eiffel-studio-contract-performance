...
struct eif_ex_260 {union overhead overhead; char data [8];};
struct eif_ex_293 {union overhead overhead; char data [8];};
struct eif_ex_325 {union overhead overhead; char data [8];};
struct eif_ex_402 {union overhead overhead; char data [8];};
struct eif_ex_454 {union overhead overhead; char data [8];};
struct eif_ex_458 {union overhead overhead; char data [8];};
struct eif_ex_463 {union overhead overhead; char data [8];};
struct eif_ex_467 {union overhead overhead; char data [8];};
struct eif_ex_471 {union overhead overhead; char data [8];};
struct eif_ex_511 {union overhead overhead; char data [8];};
